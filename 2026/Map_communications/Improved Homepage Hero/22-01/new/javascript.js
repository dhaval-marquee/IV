function loadTestCode() {
    if (!jQuery('body').hasClass('iv-Homepage')) {
        ...
        jQuery('.iv-Homepage main .banner-content .banner-btn').after(`<ul class="listItems">
        ...
        <div class="iv-btnWrapper">
            <a href="https://www.mapcommunications.com/contact-us/request-free-trial" class="startFreeTrialBtn head-fill-btn">Start Free Trial</a>
