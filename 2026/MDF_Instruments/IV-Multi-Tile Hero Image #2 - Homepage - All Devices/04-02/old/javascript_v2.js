    ...
    function loadTestCode() {
        ...
        <div class="iv-hero-wrapper iv-hero-wrapper--js">
            ...
            <div class="iv-hero-slider iv-hero-right-bottom">
                <picture>
                    <source media="(max-width: 767px)" srcset="https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/MDF_Instruments/MultiTileHeroImage2/procardial-titanium-mprints.jpg">
                    <img src="https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/MDF_Instruments/MultiTileHeroImage2/procardial-titanium-mprints-desktop.jpg" alt="Stethoscope Set Bundles">
                </picture>
                <div class="iv-hero-content">
                    <span class="iv-eyebrow">Save up to 20% by bundling your stethoscope with our accessories & apparel!</span>
                    <h2>Stethoscope Set Bundles</h2>
                    <a class="button" href="https://mdfinstruments.com/collections/stethoscope-sets">SHOP BUNDLES</a>
                </div>
            </div>
        </div>`;
