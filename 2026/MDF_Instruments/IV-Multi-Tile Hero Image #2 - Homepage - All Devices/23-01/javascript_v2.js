        ...
        <div class="iv-hero-wrapper iv-hero-wrapper--js">
            <div class="iv-hero-slider iv-hero-left">
                ...
                <div class="iv-hero-content">
                    ...
                    <h2>UP TO 30% OFF</h2>
                    <a class="button" href="https://mdfinstruments.com/collections/deals">SHOP NOW</a>
                </div>
            </div>
            ...
            <div class="iv-hero-slider iv-hero-right-top">
                ...
                <div class="iv-hero-content">
                    ...
                    <a class="button" href="https://mdfinstruments.com/collections/scrubs-and-medical-apparel">SHOP NOW</a>
                </div>
            </div>

            <div class="iv-hero-slider iv-hero-right-bottom">
                <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1769062254/MDF_Instruments/MultiTileHeroImage2/procardial-titanium-mprints.jpg" alt="PROCARDIAL MPRINTS">
                <div class="iv-hero-content">
                    <span class="iv-eyebrow">$30 OFF + FREE ADD-ONS WORTH $80</span>
                    <h2>PROCARDIAL MPRINTS</h2>
                    <a class="button" href="https://mdfinstruments.com/collections/stethoscope-sets">SHOP NOW</a>
                </div>
            </div>
        </div>`;
