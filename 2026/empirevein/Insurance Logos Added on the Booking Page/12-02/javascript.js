function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-insurance-logos')) {
        ...
        const insuranceLogos = [
            ...
            {
                src: "https://res.cloudinary.com/ignite-visibility/image/upload/v1770816861/empirevein/InsuranceLogosBookingPage/AlphaCareMedicalGroupLogo.png",
                width: 200,
                height: 62
            },
            {
            ...
            {
                src: "https://res.cloudinary.com/ignite-visibility/image/upload/v1770816859/empirevein/InsuranceLogosBookingPage/lasallemedicalgroupLogo.png",
                width: 200,
                height: 59
            },
            {
                src: "https://res.cloudinary.com/ignite-visibility/image/upload/v1770816856/empirevein/InsuranceLogosBookingPage/RIOS-SouthwestMedicalGroupLogo.png",
                width: 331,
                height: 152
            },
            {
            ...
            {
                src: "https://res.cloudinary.com/ignite-visibility/image/upload/v1770816855/empirevein/InsuranceLogosBookingPage/TriwestLogo.png",
                width: 358,
                height: 141
            }
        ];
