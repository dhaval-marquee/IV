function loadTestCode() {
    if (document.querySelector('body').classList.contains('iv-floating')) return;
        document.querySelector('body').classList.add('iv-floating');

    const floatingCta = `
        <div class="iv-floating-warp" style="display:none;">
            <a class="iv-close-cta closeIcon" href="javascript:void(0);">
