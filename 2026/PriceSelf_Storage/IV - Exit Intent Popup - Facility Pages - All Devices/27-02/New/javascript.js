function set_cookie(cname, cvalue, exdays) {
    ...
    document.cookie = cname + "=" + cvalue + ";secure;" + expires + "https://www.priceselfstorage.com/locations/";
}
...
function preloadExitBackground(callback) {
    ...
    const img = new Image();
    img.src = isMobile
        ? "https://res.cloudinary.com/ignite-visibility/image/upload/v1772099044/PriceSelfStorage/ExitIntentPopupFacilityPages/FacilityPagesDesN.png"
        : "https://res.cloudinary.com/ignite-visibility/image/upload/v1772099044/PriceSelfStorage/ExitIntentPopupFacilityPages/FacilityPagesDesN.png";
...
function exitModal() {
    ...
    if(!document.querySelector('body').classList.contains('exitModal')) {
        ...
        document.addEventListener('click', function(e) {
            if(e.target && (e.target.className.includes('exitModalClose') || e.target.className.includes('reserveNowBtn') || e.target.className.includes('linkKeepBrowsing') || e.target.className.includes('exitModal_overlay'))) {
