...
function preloadExitBackground(callback) {
    ...
    img.src = isMobile
        ...
        : "https://res.cloudinary.com/ignite-visibility/image/upload/v1771307642/PriceSelfStorage/ExitIntentPopupFacilityPages/FacilityPagesDes.png";
                ...
                <div class="exitModalBox_inner">
                    <div class="exitModalBox_block">
                        ...
                        <div class="exitModalBox_content">
                            <h2>WAIT!</h2>
                            <p class="subtitleExitModal">Our prices change frequently due to availability and market rates.</p>
                            <p>Make a FREE reservation to lock in your rate and finish your rental agreement when you’re ready.</p>
                        </div>
                        <a href="javascript:;" class="reserveNowBtn">Reserve Now - It’s Free!</a>
                    </div>
                </div>
            </div>
        `);
