function loadTestCode() {
    if (!jQuery('body').hasClass('homepage_iv')) {
        ...
        // For Variant 2 only
        jQuery('#link_button-793-103').before('<img style="margin-bottom:35px;max-width: 100%;" src="https://trueyouweightloss.com/wp-content/uploads/TYWL-Clinic-Comparison.png">');
        jQuery('#link_button-793-103').text('Request a Consultation or Just Learn More');
    }
}

var loadTest = setInterval(function () {
    if (typeof jQuery != 'undefined' && document.querySelectorAll('#new_columns-64-103').length > 0) {
