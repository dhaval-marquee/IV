function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-contact')) {
        ...
        document.querySelector('.entry-header h1').innerText = "#1 provider of VenaSeal™ treatments in the U.S.A.";
        document.querySelector('.entry-header .subtext').innerText = "More than 99% of Varicose Vein Treatments are covered by insurance.";
        document.querySelector('.entry-header').insertAdjacentHTML('beforeend', `<h2>FREE 15 minute consultation!</h2>`);
