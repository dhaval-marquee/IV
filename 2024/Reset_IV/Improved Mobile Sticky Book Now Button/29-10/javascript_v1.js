function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-sticky-button')) {
        ...
        const packageName = document.querySelector('.proudct-breadcrumb.d-xl-none ul li a').innerText.toLowerCase();

        const productNameDiv = `<div class="sticky-product-name">${productName} - ${packageName}</div>`;
