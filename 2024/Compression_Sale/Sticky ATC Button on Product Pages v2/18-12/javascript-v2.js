function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-sticky-ATC')) {
        ...
        if (document.querySelector('.product-title') && !document.querySelector('.sticky-atc-section')) {
                ...
                if (links.length > 0) {
                    ...
                    links.forEach(link => {
                        link.addEventListener('click', function(event) {
                            ...
                            const targetSection = document.querySelector('form[id*="product_form"]');
            ...
            const atcButton = document.querySelector('.product-form--regular .anu_inner_qty .btn_crt .add-cta');
            ...
            const handleVisibilityCheck = () => {
                if (atcButton) {
                    if (isElementInViewport(atcButton)) {
            ...
            // const ctaButton = document.querySelector(".sticky-atc-section .add-cta > a");
            // const actionButton = document.querySelector(".product-form--regular .anu_inner_qty .btn_crt .product-form--atc-button");
            // if (ctaButton && actionButton) {
