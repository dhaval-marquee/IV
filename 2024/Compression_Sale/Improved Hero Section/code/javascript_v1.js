function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-home')) {
        ...
        const heroContent = `
            <div class="iv-hero">
                <div class="container-fluid"> 
                    ...
                    <p>Premium quality compression socks, stockings, sleeves, and wraps from top brands like Jobst, Sigvaris, and Juzo at <u>unbeatable prices.</u></p>
                    <ul class="iv-hero-list">
                        ...
                        <li><img src="//res.cloudinary.com/ignite-visibility/image/upload/f_auto/Compression_Sale/round_dollar_blue.png"><span>Low Price Guaranteed</span></li>
                    </ul>
        ...
        document.querySelector('.iv-hero-button .product-Finder').addEventListener('click', function(){
