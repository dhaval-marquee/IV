        ...
        const applyStickySpecificChanges = (() => {
            ...
            return () => {
                ...
                function adjustFooterPadding() {
                    const productButton = document.querySelector('.iv-sticky-ATC .product-button');
                    const footerTop = document.querySelector('.iv-sticky-ATC .footer-top');
                    if (productButton && footerTop) {
                        const productButtonHeight = productButton.offsetHeight;
                        footerTop.style.paddingBottom = `${productButtonHeight}px`;
                    }
                }
