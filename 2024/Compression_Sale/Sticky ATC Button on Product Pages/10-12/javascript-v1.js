            ...
            return () => {
                ...
                function createSelectBoxForOptionGroup(optionName, fieldsetSelector) {
                    ...
                    if (targetFieldset) {
                        ...
                        document.querySelectorAll('.iv-sticky-ATC .product-button .product_options fieldset.form-options:nth-child(2) .option-values .option-value input')
                            .forEach(function(check) {
                                if (check.checked) {
                                    check.closest('.option-value').classList.add("iv-color-show");
                                }
                            });
                        ...
                        selectBox.addEventListener('change', () => {
                            ...
                            document.querySelectorAll('.iv-sticky-ATC .product-button .product_options fieldset.form-options:nth-child(2) .option-values .option-value')
                                .forEach(option => option.classList.remove("iv-color-show"));
                ...
                // Create select box for "Color"
                createSelectBoxForOptionGroup('Color', '.iv-sticky-ATC .product-button .product_options fieldset.form-options:nth-child(2)');
