function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-quiz-form')) {
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 text-center">
                        <h2 class="margin-bottom--30 pss-font-primary-bold">What storage solution are you looking for?</h2>
                    </div>
                </div>
                <div class="row">
        ...
        if (!document.querySelector('.storage-section') && document.querySelector('.iv-quiz-form .pss-home')) {
            document.querySelector('.iv-quiz-form .pss-home').insertAdjacentHTML('afterend', storageBoxSection);
        }
                ...
                <div class="model-container">
                    <div class="model-content">
                        <div class="model-head">
                            <a href="javascript:;" class="model-previous-button">
                                <svg xmlns="http://www.w3.org/2000/svg" width="98" height="38" viewBox="0 0 98 38" fill="none">
                                    <path d="M1.23223 17.2322C0.25592 18.2085 0.25592 19.7915 1.23223 20.7678L17.1421 36.6777C18.1184 37.654 19.7014 37.654 20.6777 36.6777C21.654 35.7014 21.654 34.1184 20.6777 33.1421L6.53554 19L20.6777 4.85786C21.654 3.88155 21.654 2.29864 20.6777 1.32233C19.7014 0.34602 18.1184 0.34602 17.1421 1.32233L1.23223 17.2322ZM98 16.5L3 16.5V21.5L98 21.5V16.5Z" fill="#A0A0A0"/>
                                </svg>
                        ...
                        <div class="step step-2">
                            <div class="model-body">
                                <div class="quiz-question">How much storage space do you need?</div>
                                ...
                                <div class="quiz-storage">
                                    ...
                                    <div id="large" class="tab-content">
                                        <div class="tab-content-box">
                                            <div class="tab-content-img">
                                                <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1732180738/PriceSelfStorage/StoragePickerQuiz/Locker-Storage.png" />
                                            </div>
                                            <p>Large</p>
                                        </div>
                                    </div>
                                ...
                                <div class="toggle-section">
                                    <div class="toggle-header" id="toggleButton">
                                        ...
                                        <span class="arrow">
                                            ...
                                            <path d="M17.1458 17.8038C15.9688 19.0084 14.0312 19.0084 12.8542 17.8038L0.927052 5.59655C-0.929073 3.69684 0.416893 0.5 3.07285 0.5L26.9271 0.5C29.5831 0.5 30.9291 3.69684 29.0729 5.59656L17.1458 17.8038Z" fill="#D9D9D9"/>
                                            </svg>
                                        </span>
                                    </div>
                                    <div class="toggle-content" id="toggleContent">
                                        <p><strong>Small:</strong> Small storage units are perfect for home-based online businesses to store products you sell (inventory) before shipment. It could also store seasonal items, like clothing, shoes, or office supplies for small businesses.</p>
                                        <p><strong>Medium:</strong> Medium units are great for offices, small businesses, contractors, and creatives needing space to store inventory, tools, or seasonal goods like product stock, office supplies, and equipment.</p>
                                        <p><strong>Large:</strong> Large units are deal for businesses storing bulk inventory, office furniture, or heavy equipment. Perfect for wholesalers, construction companies, and event planners to store items like furniture, machinery, tools, or large products before shipment.</p>
                                    </div>
                                </div>
        ...
        if (!document.querySelector('.quiz-model')) {
            ...
            // Select all storage-box elements
            ...
            document.querySelector('.location-search input').addEventListener('input', function () {
                document.querySelector('#txtHomeSearch').value = this.value;
            ...
            document.querySelector('.find-cta').addEventListener('click', function (event) {
                ...
                if (inputField.value.trim() === '') {
                    ...
                    errorMessage.style.display = 'none';
                    document.querySelector('#MainContent_btnHomeSearch').click();
