function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-quiz-form')) {
        ...
        function triggerTabsBasedOnsessionStorage(key, containerSelector) {
            ...
            if (tabText) {
                ...
                if (container) {
                    ...
                    buttons.forEach(button => {
                        if (button.textContent.trim() === tabText) {
                            button.click();
        ...
        triggerTabsBasedOnsessionStorage("tabText", ".locationContent .pss-filters-row");
