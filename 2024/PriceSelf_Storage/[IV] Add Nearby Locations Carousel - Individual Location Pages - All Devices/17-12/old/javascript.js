    ...
    if (!$('body').hasClass('location-iv')) {
                        ...
                        ${['one', 'two', 'three'].map(i => `
                            <div class="pss-card pss-card-${i}">
                                ...
                                <div class="pss-card__contentbox">
                                    ...
                                    <div class="pss-card__distance"><svg><use href="/Assets/sprite/icons.svg#address"></use></svg></div>
                                </div>
                                <div class="pss-card__actions">
                                    <a href="" class="pss-button pss-button__cta-blue">View Units</a>
                                    <div class="pss-rating_star">
                                        <div class="star-rating"><img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1706773346/Aireserv/five-star.png" alt="Star" class="star-icon"></div>
        ...
        locations.forEach((loc, idx) => {
            ...
            $.get(dynamicURL, function(response) {
                ...
                let address = $(response).find('.pss-facility__content-address .pss-link > span').text();
                ...
                $(`.pss-card-${loc} .pss-card__title a`).attr('href', dynamicURL).text(title);
                $(`.pss-card-${loc} .pss-card__actions a`).attr('href', dynamicURL);

                // Update the text for address, distance, and rating
                $(`.pss-card-${loc} .pss-card__address`).text(address);
                $(`.pss-card-${loc} .pss-card__distance svg`).after(`${itemMiles}les Away`);
