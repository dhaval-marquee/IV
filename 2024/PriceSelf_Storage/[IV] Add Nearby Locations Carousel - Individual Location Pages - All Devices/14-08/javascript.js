function loadTestCode() {
    if (!$('body').hasClass('locationSectionIV')) {
        ...
        $('.pss-facility-faq-holder').before(`<div class="locationSection" style="display: none">
            <div class="sectionTop">
                <h2>Nearby Storage Locations</h2>
                ...
                if (navigator.geolocation) {
                    navigator.geolocation.getCurrentPosition(
                        function(position) {
                            ...
                            $('.dynamicContentWrapper .pss-card-list__imagebox img.lazy').each(function() {
                            ...
                            $.getScript("//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js", function () {
                                $('#MainContent_LocationRepeater').slick({
                                    autoplay: true,
                                    arrows: true,
                                    buttons: false,
                                    infinite: true,
