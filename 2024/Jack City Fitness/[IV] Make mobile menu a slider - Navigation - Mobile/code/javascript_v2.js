function loadTestCode() {
    ...
    if (!document.querySelector('body').classList.contains(tag)) {
        ...
        var tryFree = document.querySelector('.mobile #content-inner .clicks [title="Driving Directions"]');
        tryFree.removeAttribute('href')
        tryFree.innerText="Try For Free";
        tryFree.addEventListener("click" , function(){
            document.querySelector(".desktop header .fourteen-hundred .custom-try-for-free a").click();
        })
    }
}
