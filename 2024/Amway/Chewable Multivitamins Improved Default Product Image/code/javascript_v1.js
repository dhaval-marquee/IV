function loadTestCode() {
    if (!$('body').hasClass('productImage')) {
        ...
        var thumbNailImage = 'https://res.cloudinary.com/ignite-visibility/image/upload/c_fill,h_60,w_60,f_auto/amway/Nutrilit_Kids_Daily_Chewable_Multivitamins_v1.png';
        var imagePath = 'https://res.cloudinary.com/ignite-visibility/image/upload/amway/Nutrilit_Kids_Daily_Chewable_Multivitamins_v1.png';
