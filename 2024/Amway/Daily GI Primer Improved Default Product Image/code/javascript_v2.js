function loadTestCode() {
    if (!$('body').hasClass('productImage')) {
        ...
        var thumbNailImage = 'https://res.cloudinary.com/ignite-visibility/image/upload/c_fill,h_60,w_60,f_auto/amway/Nutrilite_Begin_Daily_GI_Primer_v2.png';
        var imagePath = 'https://res.cloudinary.com/ignite-visibility/image/upload/amway/Nutrilite_Begin_Daily_GI_Primer_v2.png';
