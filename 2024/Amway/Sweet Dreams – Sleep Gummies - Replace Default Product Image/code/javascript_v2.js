function loadTestCode() {
    if (!$('body').hasClass('productImage')) {
        ...
        var thumbNailImage = 'https://res.cloudinary.com/ignite-visibility/image/upload/c_fill,h_60,w_60,f_auto/amway/Sweet_Dreams_Sleep_Gummies_-_V2.png';
        var imagePath = 'https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/amway/Sweet_Dreams_Sleep_Gummies_-_V2.png';
