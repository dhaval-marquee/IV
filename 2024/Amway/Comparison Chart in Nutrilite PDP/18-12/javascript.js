function loadTestCode() {
    if (!$('body').hasClass('comparison_iv')) {
        ...
        $('#skip-to-content .productDetailsPageRightBottomSlot > div').eq(1).after(`<div class="comparison-section">
            <div class="container">
                ...
                <div class="comparison-table">
                    <table cellpadding="0" cellspacing="0" class="product-2" id="comparisonTable">
                        <thead>
                            <tr class="product-image">
                                ...
                                <th>
                                    ...
                                    <a href="https://www.amway.com/en_US/Nutrilite%E2%84%A2-Organics-All-in-One-Meal-Powder-%E2%80%93-Berry-p-318672?backRef=aHR0cHM6Ly93d3cuYW13YXkuY29tL2VuX1VTL3NlYXJjaC8/dGV4dD1udXRyaWxpdGUrb3JnYW5pY3MmaW5pdGlhbFBhZ2U9MQ==">
                                        <img src="/medias/318672-en-US-1800px-03?context=bWFzdGVyfGltYWdlc3wxNzA1NjI4fGltYWdlL3BuZ3xzeXMtbWFzdGVyL2ltYWdlcy9oZWMvaDAwLzk3NDI2NDgxODA3NjYvMzE4NjcyLWVuLVVTLTE4MDBweC0wM3w1ZDBhODg2YTNkY2FkM2ZhZGZlZmFjZGM4ODJkOWUxMGEzZDc3ODRhOWJkMTQ3Njk0OThhZjg1MzdmYmYwMDY5" alt="Product 1"/>
                                    </a>
                                </th>
                                <th>
                                    <h3>This item</h3>
        ...
        $('#comparisonTable').on('click', 'td, th', function() {
            var index = $(this).index();
            if(index > 0) {
                $("#comparisonTable").removeClass(function (index, className) {
                    return (className.match(/(^|\s)product-\S+/g) || []).join(' ');
                });
                $("#comparisonTable").addClass("product-" + index);
            }
        });
    }
}
