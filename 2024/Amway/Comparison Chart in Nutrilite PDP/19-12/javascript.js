function loadTestCode() {
    if (!$('body').hasClass('comparison_iv')) {
        ...
        if (currentPage == 'https://www.amway.com/en_US/Nutrilite%E2%84%A2-Organics-All-in-One-Meal-Powder-%E2%80%93-Berry-p-318672') {
            console.log('Product 1');
            document.querySelector('#comparisonTable').classList.add('product-1');
        } else if(currentPage == 'https://www.amway.com/en_US/Nutrilite%E2%84%A2-Organics-Plant-Protein-Powder-%E2%80%93-Unflavored-%28125925%29-p-125925') {
            console.log('Product 2');
            document.querySelector('#comparisonTable').classList.add('product-2');
        } else if (currentPage == 'https://www.amway.com/en_US/XS%E2%84%A2-Protein-Pods-%E2%80%93-Vanilla-p-300855') {
