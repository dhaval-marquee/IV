function loadTestCode() {
    ...
    if (!document.querySelector('body').classList.contains(tag)) {
        ...
        const reviewImg = `${cloudInary}reviewImg.png`;
        const HIPAALogo = `${cloudInary}HIPAA.png`;
        const PCI_DSSLogo = `${cloudInary}PCI_DSS.png`;
        const ISOLogo = `${cloudInary}ISO.png`;
        ...
        var companyLogoHtml = `<div class="${tag}-company-logo">
            <div class="company-logo-container">
                <div class="companys-in-logo">
                    <img src="${HIPAALogo}" alt="company img" class="hipaaLogo"/>
                    <img src="${PCI_DSSLogo}" alt="company img" class="pciLogo"/>
                    <img src="${ISOLogo}" alt="company img" class="isoLogo"/>
                </div>
            </div>
        </div>`;
