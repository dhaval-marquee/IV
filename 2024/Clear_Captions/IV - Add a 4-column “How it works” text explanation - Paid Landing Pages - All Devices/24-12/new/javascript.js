                ...
                <div class="container">
                    <div class="accordion">
                        <div class="accordion-item active">
                            <div class="accordion-header">
                                <div class="accordion-header-img">    
                                    <img src="https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/ClearCaptions/User-icon-with-checkmark.png" width="60" alt="Determine your eligibility">
                                </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header">
                                <div class="accordion-header-img">    
                                    <img src="https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/ClearCaptions/note-with-pen.png" width="50" alt="Complete our form">
                                </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header">
                                <div class="accordion-header-img">    
                                    <img src="https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/ClearCaptions/bright-bulb.png" width="55" alt="Receive training & free installation">
                                </div>
                        ...
                        <div class="accordion-item">
                            <div class="accordion-header">
                                <div class="accordion-header-img">    
                                    <img src="https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/ClearCaptions/men-speaking.png" width="58" alt="Enjoy communicating independently once again">
                                </div>
                                <h3>4. Enjoy communicating <em class="title-italic">independently once again</em></h3>
                                <span class="accordion-arrow"></span>
                            </div>
                            <div class="accordion-body" style="display: none;">
                                <p>Relax while an expert installs your new phone at no cost, then receive personalized training until you feel completely confident using the captioning service.</p>
