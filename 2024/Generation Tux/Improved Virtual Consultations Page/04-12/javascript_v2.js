    ...
    if (!document.querySelector('body').classList.contains('iv-virtual')) {
        ...
        const heroRight = `
            <div class="hero-right-content">
                <h2 class="text-h1-display hero-title">Effortless Wedding Suit Advice, Anytime, Anywhere</h2>
                <p class="mb-16">Book a hassle-free online consultation and design your perfect look.</p>
                <ul>
                    <li>Virtual styling sessions with personalized suggestions.</li>
                    <li>Choose from a wide selection of premium fabrics and colors.</li>
                    <li>Access to ongoing support until your wedding day.</li>
                </ul>
