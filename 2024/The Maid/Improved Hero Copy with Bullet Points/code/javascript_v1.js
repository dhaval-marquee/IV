function loadTestCode() {
    if (!jQuery('body').hasClass('bulletPoints_iv')) {
        ...
        jQuery('#hero-section-left .section-background').html(`
            <h1>Personalized cleaning services that fit your budget & lifestyle</h1>
            <ul>
        ...
        jQuery('#hero-section-right').html(`
            <picture>
                <source media="(max-width:767.98px)" srcset="https://cdn-ikpkfpn.nitrocdn.com/GgSQfJmDdcyTssVfjcXUMhEnReCcaZWO/assets/images/optimized/rev-7fb833b/www.maids.com/wp-content/uploads/2023/03/Home-Header-Photo-Dog.png">
                <img src="https://www.maids.com/wp-content/uploads/2023/03/Home-Header-Photo-Dog.png" alt="Home Header Photo Dog Image">
            </picture>`
        );
    }
}
