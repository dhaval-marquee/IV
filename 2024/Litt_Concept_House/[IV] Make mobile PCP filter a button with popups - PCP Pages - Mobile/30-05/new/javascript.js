function mobileTestOnly() {
    if (!document.querySelector('body').classList.contains('filterTestIV')) {
        ...
        var sidebarBlocks = document.querySelectorAll(".sidebar__block");
        ...
        document.querySelector('.sidebarIV .popupHeader').after(document.querySelector('.collection__filters'));
