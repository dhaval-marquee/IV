        ...
        const heroContent = `
            <div class="from-left col-12 col-lg-6">
                ...
                <ul class="from-left-list">
                    <li>Access cutting-edge tools for seamless eligibility verification.</li>
                    <li>Transform your collections process with expert strategies.</li>
                    <li>Gain actionable insights to drive better financial outcomes.</li>
                </ul>
            </div>`;
