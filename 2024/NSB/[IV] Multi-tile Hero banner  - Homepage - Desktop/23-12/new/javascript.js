function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-hero')) {
            ...
            if (!document.querySelector('.iv-hero-right')) {
                const heroRight = `<div class="iv-hero-right">
                    <div class="hero-right hero-right-top">
                        ...
                        <p> Trending themes for 2025</p>
                        <a href="/blog/" class="iv-button iv-button-red-bg">See most popular topics</a>
                    </div>
                        ...
                        <div class="hero-sliders">
                            <div style="background-image: url('//res.cloudinary.com/ignite-visibility/image/upload/f_auto/NSB/large-George_S.png');" class="hero-right hero-slider">
                                <div class="content-inner">
                                    ...
                                    <p>Host on the art of listening, creating space, and building connections</p>
                            ...
                            <div style="background-image: url('//res.cloudinary.com/ignite-visibility/image/upload/f_auto/NSB/largeAmie-Sara.jpg');" class="hero-right hero-slider">
                                <div class="content-inner">
                                    <span>Trending speakers</span>
        ...
        document.querySelector('.featured-form-left').after(document.querySelector('.featured-form + p'));
        ...
        loadScript("//cdn.jsdelivr.net/npm/slick-carousel@1.8.1/slick/slick.min.js")
            .then(() => {
                $('.hero-sliders').slick({
                    ...
                    dots: false,
                    autoplay: false,
                    nextArrow: '<div class="next"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="25" fill="none" viewBox="0 0 20 35"><path fill="#000" fill-rule="evenodd" d="M13.155 18.948c.8-.8.8-2.096 0-2.896L.6 3.497C-.2 2.697-.2 1.4.6.6c.8-.8 2.097-.8 2.897 0l15.452 15.452c.8.8.8 2.096 0 2.896L3.497 34.4c-.8.8-2.097.8-2.897 0-.8-.8-.8-2.097 0-2.897l12.555-12.555z" clip-rule="evenodd"></path></svg></div>',
                    prevArrow: '<div class="prev"><svg xmlns="http://www.w3.org/2000/svg" width="15" height="25" fill="none" viewBox="0 0 20 35"><path fill="#000" fill-rule="evenodd" d="M6.394 18.948c-.8-.8-.8-2.096 0-2.896L18.948 3.497c.8-.8.8-2.097 0-2.897-.8-.8-2.096-.8-2.896 0L.6 16.052c-.8.8-.8 2.096 0 2.896L16.052 34.4c.8.8 2.096.8 2.896 0 .8-.8.8-2.097 0-2.897L6.394 18.948z" clip-rule="evenodd"></path></svg></div>',
                });
            })
            .catch(error => {
                console.error(error);
...
var checkCondition = setInterval(function () {
    if (document.querySelectorAll('body').length > 0 && typeof jQuery != 'undefined') {
