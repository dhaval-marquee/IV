            ...
            <div class="container">
                <div class="es-row">
                    <div class="emergency-service-details">
                        ...
                        <h3>Call for 24/7 emergency support or schedule an appointment online.</h3>
                    </div>
                    <div class="emergency-service-action">
                        <button class="services-btn secondary-btn" data-toggle="modal" data-target="#js-schedulerDialog" title="Request Appointment - opens in new tab-modal">Request Appointment</button>
