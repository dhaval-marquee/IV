                        ...
                        .then(htmlString => {
                            ...
                            if (data) {
                                ...
                                itemsToAdd.forEach(item => {
                                    ...
                                    const MinimumInsurance = item.querySelector('.iv-top-item .iv-new-item .unitsTable .unitCellRightGroup .unitsCellRight .cardPrice .startingFromText').innerText;
                                    const unitButtonsWrappers = document.querySelectorAll('.iv-top-item .iv-new-item .unitsTable .unitCellRightGroup .unitsCellRight .unitSelectOptions .unitButtonsWrapper');
                                    unitButtonsWrappers.forEach(wrapper => {
                                        if (!wrapper.previousElementSibling || !wrapper.previousElementSibling.classList.contains('policy-text')) {
                                            wrapper.insertAdjacentHTML('beforebegin', `<span class="policy-text">${MinimumInsurance}</span>`);
                                        }
                                    });
