                ...
                <ul class="fadein">
                    <li>
                        <div class="list-img-wrapper">
                            <img src="//res.cloudinary.com/ignite-visibility/image/upload/f_auto/Store-IT/Accessible.png" alt="Select Your Unit">
                        </div>
                    ...
                    <li>
                        <div class="list-img-wrapper">
                            <img src="//res.cloudinary.com/ignite-visibility/image/upload/f_auto/Store-IT/Security.png" alt="Rent online">
                        </div>
                        <h3>Rent online</h3>
                    ...
                    <li>
                        <div class="list-img-wrapper">
                            <img src="//res.cloudinary.com/ignite-visibility/image/upload/f_auto/Store-IT/Term-Contract.png" alt="Move in!">
                        </div>
                        <h3>Move in!</h3>
