function modal() {
    if(!jQuery('body').hasClass('proPop_iv')) {
                ...
                <div class="mq_modal_inner">
                    <div class="mq_modal_block">
                        ...
                        <div class="mq_modal_content">
                            <div class="popUpContent active" service-popup="1">
                                <div class="service-text">
                                    <div class="service-titles">
                                        <h2>SureTrack Real Fixes</h2>
                                        <p class="second-title">The SureTrack Community is an interactive tool inside ProDemand that you can use to collaborate with other professional technicians in order to solve a tricky diagnostic problem.</p>
                                    </div>
                                    <div class="copy">                         
                                        <ul>
                                            <li>
                                        ...
                                        <div>
                                            <a href="javascript:;" class="btn" data-toggle="modal">Book Your Free Demo</a>
                                        </div>
                                        <a class="service-link vwo_loaded vwo_loaded_7"href="https://www.maids.com/services/one-time-cleaning-services/">Learn more about 1Search Plus</a>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        jQuery('.mq_modal_content').prepend(`<div class="popUpContents">
            <div class="popUpContent" service-popup="1">
                <div class="service-text">
                    ...
                    <div class="service-content">                         
                        ...
                        <button type="button" class="service-btn hs-cta-trigger-button">Book Your Free Demo</button>
            ...
            <div class="popUpContent active" service-popup="3">
                <div class="service-text">
                    <h2>SureTrack Real Fixes</h2>
                    <div class="service-content">                         
