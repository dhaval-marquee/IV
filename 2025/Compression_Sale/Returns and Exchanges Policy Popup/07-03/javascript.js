function loadTestCode() {
  if (!jQuery("body").hasClass("iv-content")) {
      ...
      tab3.after(`
        <div class="popup-overlay" style="display:none;">
            <div class="popup-box">
                ...
                <a href="#" class="close-two close-popup">Sounds good!</a>
            </div>
        </div>
    `);
    }
    ...
    // Open popup
    jQuery("#shopify-section-static-product .tab-content #tab-3 .open-popup").on(
      "click",
      function () {
    ...
    jQuery(document).on("click", ".popup-overlay, .close-popup", function (e) {
      if (
        jQuery(e.target).hasClass("popup-overlay") ||
