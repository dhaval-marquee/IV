    ...
    if (!document.querySelector('body').classList.contains('iv-security-banner')) {
        ...
        if (rentalListSection){
            ...
            if (children.length >= 3) {
                ...
                const ivBannerContent = `<div class="iv-security-banner-section iv-security-banner-section-v2">
                        <div class="iv-security-banner-inner">
                            <div class="iv-banner-img">
                                <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1743506110/Store-IT/v2-banner-img-new.png" alt="Security banner image">
                            </div>
                            <div class="iv-banner-content">
                                ...
                                <p class="iv-banner-desc">At Stor-It, we take storing your belongings seriously.</p>
                            </div>  
                        </div>
                </div>`;
...
const checkCondition = setInterval(function() {
    if (document.querySelector('body') && document.querySelector('#unitsSection .rental-list > div')) {
