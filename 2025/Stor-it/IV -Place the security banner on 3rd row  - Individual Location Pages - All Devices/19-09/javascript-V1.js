    ...
    if (!document.querySelector('body').classList.contains('iv-security-banner')) {
        ...
        if (rentalListSection) {
            ...
            if (children.length >= 3) {
                ...
                const ivBannerContent = `<div class="iv-security-banner-section iv-security-banner-section-v1">
                        <div class="iv-security-banner-inner">
                            <div class="iv-banner-img">
                                <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1743506109/Store-IT/v1-banner-img-new.png" alt="Security banner image">
                            </div>
