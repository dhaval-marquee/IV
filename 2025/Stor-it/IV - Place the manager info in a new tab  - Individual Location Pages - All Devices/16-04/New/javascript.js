function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-manager-tab')) {
        ...
        const ivManagerList = [
            ...
            {
                name: 'Eric',
                info: 'Eric enjoys talking to new people every day and hearing their amazing stories. While a relatively fresh face a Stor-It, Geoffrey has really jumped right into our mantra of teamwork and family environment. He advises customers to check the unit out before renting. Eric loves camping and exploring the beautiful state of Idaho.',
            },
            {
                name: 'Joe Sr.',
        ...
        // Get the name from the element: e.g., "Meet Ken:" => "Ken"
