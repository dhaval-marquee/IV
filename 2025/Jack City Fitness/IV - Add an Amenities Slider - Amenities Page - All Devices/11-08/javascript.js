        ...
        document.querySelector('.iv-Homepage section#section-1 .button-margin').insertAdjacentHTML('beforebegin',`<div class="boxWrapper">
            <div class="leftBox">
                <div class="imgWrapper">
                    <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1732000376/jackcityfitness/WeightGymEquipment.png" alt="SAFETY AND CLEANLINESS AT JACK CITY FITNESS">
                </div>
            ...
            <div class="rightBox">
                <div class="imgWrapper">
                    <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1732000373/jackcityfitness/DedicatedCoaching.png" alt="ON-SITE PARKING AT JACK CITY FITNESS">
                </div>
...
var checkCondition = setInterval(function() {
    if (document.querySelectorAll('.iv-Homepage section#section-1 .button-margin').length > 0) {
