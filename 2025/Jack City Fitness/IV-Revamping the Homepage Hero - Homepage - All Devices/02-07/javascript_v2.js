...
function initializeSlider() {
    ...
    $('#ivHeroSlider .iv-slides').slick({
        ...
        slidesToScroll: 1,
        adaptiveHeight: true,
        prevArrow: '<button class="iv-arrow left" aria-label="Previous Slide"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" viewBox="0 0 24 24"><path d="M18 4 L10 12 L18 20" stroke="currentColor" stroke-width="2" fill="none" ></path></svg></button>',
        nextArrow: '<button class="iv-arrow right" aria-label="Next Slide"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" viewBox="0 0 24 24"><path d="M8 4L16 12L8 20" stroke="currentColor" stroke-width="2" fill="none" ></path></svg></button>',
