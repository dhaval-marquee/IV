        ...
        document.querySelector('.iv-Homepage section#section-1 .button-margin').insertAdjacentHTML('beforebegin',`<div class="boxWrapper">
            <div class="leftBox">
                <div class="imgWrapper">
                    <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1754977630/jackcityfitness/car-p.png" alt="SAFETY AND CLEANLINESS AT JACK CITY FITNESS">
                </div>
            ...
            <div class="rightBox">
                <div class="imgWrapper">
                    <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1754977784/jackcityfitness/handPreview.png" alt="ON-SITE PARKING AT JACK CITY FITNESS">
                </div>
