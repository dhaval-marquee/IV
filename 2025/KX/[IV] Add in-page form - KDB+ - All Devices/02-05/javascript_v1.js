function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-hero-section')) {
        ...
        document.querySelector('header h1 + p').innerHTML = `KDB+ powers kdb Insights portfolio and <a href="http://kdb.ai/">KDB.AI</a>, together delivering time-oriented data insights and generative AI capabilities to the world’s leading enterprise organizations.`;
