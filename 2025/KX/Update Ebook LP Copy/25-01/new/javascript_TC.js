function loadTestCode() {
    if (!jQuery('body').hasClass('optinPage_iv')) {
        ...
        jQuery('.text_split_form2 ul.featured-points').html(`<li>
            <strong>Accelerate Alpha Generation</strong>
            <p>Learn how to leverage real-time data and advanced analytics to uncover hidden opportunities and outpace competitors in volatile markets.</p>
        </li>
        <li>
            <strong>Optimize Risk and Execution</strong>
            <p>Discover proven strategies and tools to enhance trade execution, mitigate risks, and ensure regulatory compliance with cutting-edge analytics.</p>
        </li>
        <li>
            <strong>Stay Ahead with Future-Ready Technology</strong>
            <p>Explore the transformative power of high-performance analytics, machine learning, and scalable platforms to dominate today's fast-moving capital markets.</p>
        </li>`);
