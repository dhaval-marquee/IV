function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-homepage')) {
                        ...
                        <ul class="splide__list">
                            ...
                            <li class="splide__slide">
                                <div class="testimonial_card testimonial_card4">
                                    <div class="testimonial_content">
                                        <div class="testimonial_text">
                                            <p>“KX brings us a technology, with a comprehensive modern software stack and a reliability that the business demands. Underpinning this, is a proven track record in the finance industry processing time-series data. The foundation is our growing technical partnership with KX, where we share innovation, improve software and deliver tangible results to our users. As we learn with KX, we are finding more and more opportunities through the business, and we are really excited as to what KX can bring.”</p>
                                        </div>
                                        <div class="testimonial_author">
                                            <h3 class="author_name">John Doe</h3>
                                            <span class="author_title">Aston Martin Red Bull Racing</span>
                                        </div>
                                        <a target="_blank" href="https://kx.com/customer-stories/aston-martin-redbull/">Read Case Study 
                                            <span>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                                                    <path d="M11.5731 5L16.6673 10M16.6673 10L11.5731 15M16.6673 10H3.33398" stroke="#ffcb22" stroke-width="1.875" stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                            ...
                            <li class="splide__slide">
                                <div class="testimonial_card testimonial_card5">
                                    <div class="testimonial_content">
                                        ...
                                        <div class="testimonial_author">
                                            <h3 class="author_name">John Doe</h3>
                                            <span class="author_title">Stifel</span>
                                        </div>
                            ...
                            <li class="splide__slide">
                                <div class="testimonial_card testimonial_card5">
                                    <div class="testimonial_content">
                                        ...
                                        <div class="testimonial_author">
                                            <h3 class="author_name">John Doe</h3>
                                            <span class="author_title">Bank of America</span>
                                        </div>
                            ...
                            <li class="splide__slide">
                                <div class="testimonial_card testimonial_card5">
                                    <div class="testimonial_content">
                                        ...
                                        <div class="testimonial_author">
                                            <h3 class="author_name">John Doe</h3>
                                            <span class="author_title">Canadian Security Regulator</span>
                                        </div>
                            ...
                            <div class="splide__list">
                                ...
                                <div class="splide__slide">
                                    <div class="child">
                                        <div>
                                            <span class="line"></span>    
                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1752307987/KX/testimonialsHomepage/Aston_Martin.webp" alt="Aston Martin Logo" class="default" width="100">
                                        </div>
                                    </div>
                                </div>
        ...
        jQuery('.company-review').before(jQuery('.customer-stories').clone().addClass('customer-Stories-first'));
    }
}
