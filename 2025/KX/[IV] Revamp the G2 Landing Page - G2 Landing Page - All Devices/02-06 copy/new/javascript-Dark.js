function loadTestCode() {
    if (!document.body.classList.contains('iv-revamp-page') && !document.body.classList.contains('iv-revamp-page-v2')) {
        ...
        const g2Competitor = document.querySelector('main > section:nth-child(4)');
        if (g2Competitor) {
        ...
        if (switchKxstarted && switchKxUltimate) {
            ...
            switchKxUltimate.setAttribute('href', '/resources/ebook/introduction-to-time-series-databases/');
        ...
        // Chris Edit 2025/05/29 - Commenting out code for reordering tabs - Decided to just change the order of the tabs via WordPress editor
