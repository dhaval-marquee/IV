function loadTestCode() {
    if (!document.body.classList.contains('iv-revamp-page', 'iv-revamp-page-v2')) {
        document.body.classList.add('iv-revamp-page', 'iv-revamp-page-v2');
            ...
            <div class="container max-width-standard">
                <div class="iv-database-inner">
                    <div class="iv-database-left">
                        ...
                        <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1748441174/KX/NavigationMenuTest/senior-technologyleadnew.png" alt="Senior Technology Lead">
                    </div>
