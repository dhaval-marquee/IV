function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-highlight')) {
        ...
        function updateCode() {
            ...
            if (segments[0] === 'collection' && segments.length === 3) {
                    ...
                    if (document.querySelector('h1').closest('.col-span-12')) {
                        ...
                        if (!document.querySelector('.iv-highlight-bottom-bar')) {
                            ...
                            document.querySelectorAll('[class*="tracker-cta-product_page-hero"]').forEach((heroCta) => {
                                const closestHero = heroCta.closest('.fixed'); // '.fixed' for class selector
                                if (closestHero) {
                            ...
                            // ------ redio section
                            // Redio section
                            const labels = document.querySelectorAll('.main-contain label');
                            ...
                            if (labels.length > 0 && ivRediosSections.length > 0) {
                                ...
                                const rentElements = document.querySelectorAll('.main-contain .items-end > p');
