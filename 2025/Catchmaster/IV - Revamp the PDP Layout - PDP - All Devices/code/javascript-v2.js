function loadTestCode() {
    if (!document.body.classList.contains('iv-revamp-the-PDP-layout')) {
        ...
        const newDescriptions = {
            ...
            <h4 class="iv-description-title">Product Description</h4>
            <p>Tired of battling unwanted mice, crickets, spiders, and other insects? Use Catchmaster®’s Max-Catch Glue Traps to capture them once and for all!</p>
            <p>Using our Intelligent Pest Management™️approach, our traps will help you take control of your pest problems without straining your time or wallet.</p>
            `,
            "https://www.catchmaster.com/products/giant-fly-glue-trap": `
            <h4 class="iv-description-title">Product Description</h4>
            <p>Say goodbye to pesky flying insects with the Catchmaster® Giant Fly Roll Glue Strip Trap!</p>
            <p>Our powerful, pre-scented adhesive fly trap paper covers up to 3,600 square inches, providing comprehensive protection for residential, commercial, and industrial spaces without the use of harmful chemicals or complicated setup.</p>
            `,
            "https://www.catchmaster.com/products/professional-strength-mouse-insect-glue-traps": `
            <h4 class="iv-description-title">Product Description</h4>
            <p>Catch even the biggest pests with ease! Catchmaster®’s Professional Strength Mouse and Insect glue traps are specially formulated, non-toxic, and easy to use.</p>
            <p>Reclaim your space and your peace of mind with our low-maintenance, mess-free glue traps. Trust the brand that the professionals do. Become a Catchmaster!</p>
            `,
            "https://www.catchmaster.com/products/pro-strength-mouse-traps-indoor-sticky-glue-boards-bulk": `
            <h4 class="iv-description-title">Product Description</h4>
            <p>A mouse-free home is a happy home! With Catchmaster®’s Pro-Strength glue boards, rid your environment of mice, rats, crawling insects, and more in just a few steps.</p>
            <p>Don’t battle your pest problems alone. One product is all you need to feel comfortable again.</p>
            `,
            "https://www.catchmaster.com/products/clothes-moth-traps-six-count-get-rid-of-clothes-moths": `
            <h4 class="iv-description-title">Product Description</h4>
            <p>Protect your closets from hungry moths with Catchmaster®'s Clothes Moth Traps!</p>
            <p>Using advanced Pheroguard Technology and professional-grade adhesive, our traps effectively attract and capture destructive moths before they damage your wool, cashmere, silk, and other fibers, eliminating the need for additional bait or stressful setups.</p>
            `
        };

        let productURL = window.location.href.split("?")[0].replace(/\/$/, "");
        if (newDescriptions[productURL]) {
            const descEl = document.querySelector(".product__description");
            if (descEl) {
                descEl.innerHTML = newDescriptions[productURL];
            }
        }
        ...
        const featuresByUrl = {
            "https://www.catchmaster.com/products/max-catch-sticky-glue-mouse-traps-original-scent": {
                heading: "Top Features and Benefits of Catchmaster Glue Traps",
                features: [{
                        title: "Ready to Use",
            ...
            "https://www.catchmaster.com/products/professional-strength-mouse-insect-glue-traps": {
                heading: "Top Features and Benefits of Mouse Glue Traps",
                features: [{
                        title: "Complete Protection",
            ...
            "https://www.catchmaster.com/products/pro-strength-mouse-traps-indoor-sticky-glue-boards-bulk": {
                heading: "Top Features and Benefits of Catchmaster Pro-Strength Traps",
                features: [{
            ...
            "https://www.catchmaster.com/products/clothes-moth-traps-six-count-get-rid-of-clothes-moths": {
                heading: "Top Features and Benefits of Catchmaster’s Pheromone Moth Traps",
                features: [{
                        title: "Built To Last",
        ...
        const pagesData = {
            "https://www.catchmaster.com/products/max-catch-sticky-glue-mouse-traps-original-scent": {
                ...
                steps: [{
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758700726/Catchmaster/RevampPDPLayout/sticky-glue-original-scent-b1.png",
                        number: "Step 1",
                        desc: "Choose the best Catchmaster product for your needs."
                    },
                    {
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758700727/Catchmaster/RevampPDPLayout/sticky-glue-original-scent-b2.png",
                        number: "Step 2",
                        desc: "Place the scented glue trap where pests are active, then remove the paper cover after 24 hours."
                    },
                    {
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758700727/Catchmaster/RevampPDPLayout/sticky-glue-original-scent-b3.png",
                        number: "Step 3",
            ...
            "https://www.catchmaster.com/products/giant-fly-glue-trap": {
                ...
                subtitle: "Just 3 simple steps to reclaim your home",
                steps: [{
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758699859/Catchmaster/RevampPDPLayout/giant-fly-glue-trap-a1.png",
                        number: "Step 1",
                        desc: "Unroll the strip, being careful not to search the adhesive."
                    },
                    {
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758699861/Catchmaster/RevampPDPLayout/giant-fly-glue-trap-a2.png",
                        number: "Step 2",
                        desc: "Hang strip (side by side) where flies are."
                    },
                    {
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758699862/Catchmaster/RevampPDPLayout/giant-fly-glue-trap-a3.png",
                        number: "Step 3",
            ...
            "https://www.catchmaster.com/products/professional-strength-mouse-insect-glue-traps": {
                ...
                subtitle: "Just 3 simple steps to reclaim your home",
                steps: [{
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758705621/Catchmaster/RevampPDPLayout/CatchmasterProStrength-c1.png",
                        number: "Step 1",
                        desc: "Unroll the trap and place it where you’ve seen pest activity."
                    },
                    {
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758705621/Catchmaster/RevampPDPLayout/CatchmasterProStrength-c2.png",
                        number: "Step 2",
                        desc: "Monitor the trap regularly."
                    },
                    {
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758705621/Catchmaster/RevampPDPLayout/CatchmasterProStrength-c3.png",
                        number: "Step 3",
            ...
            "https://www.catchmaster.com/products/pro-strength-mouse-traps-indoor-sticky-glue-boards-bulk": {
                ...
                subtitle: "Just 3 simple steps to reclaim your home",
                steps: [{
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758706350/Catchmaster/RevampPDPLayout/pro-strength-ndoor-boards-bulk-d1.png",
                        number: "Step 1",
                        desc: "Place the Catchmaster Mouse Glue Board along pest pathways."
                    },
                    {
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758706350/Catchmaster/RevampPDPLayout/pro-strength-ndoor-boards-bulk-d2.png",
                        number: "Step 2",
                        desc: "Leave the adhesive cover on for 24 hours."
                    },
                    {
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758706350/Catchmaster/RevampPDPLayout/pro-strength-ndoor-boards-bulk-d3.png",
                        number: "Step 3",
            ...
            "https://www.catchmaster.com/products/clothes-moth-traps-six-count-get-rid-of-clothes-moths": {
                ...
                subtitle: "Just 3 simple steps to reclaim your home",
                steps: [{
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758706915/Catchmaster/RevampPDPLayout/clothes-moth-six-count-e1.png",
                        number: "Step 1",
                        desc: "Remove your pheromone moth trap from the package without touching the glue."
                    },
                    {
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758706916/Catchmaster/RevampPDPLayout/clothes-moth-six-count-e2.png",
                        number: "Step 2",
                        desc: "Place traps inside your closets, wardrobes, storage chests, or drawers."
                    },
                    {
                        img: "https://res.cloudinary.com/ignite-visibility/image/upload/v1758706917/Catchmaster/RevampPDPLayout/clothes-moth-six-count-e3.png",
                        number: "Step 3",
        ...
        function initIvFaq(mount, faqData) {
            ...
            <button class="iv-accordion-btn" type="button" aria-expanded="false">
                ...
                <svg class="iv-chevron" viewBox="0 0 24 24" width="40" height="40" fill="none" stroke="currentColor" stroke-width="3"><path d="M6 9l6 6 6-6"/></svg>
                </span>
            </button>
