function dynamicProductCode() {
    ...
    function initDynamicProductBlock() {
        const productData = [{
            ...
            {
                'Crop Insects': [{
                        "title": "Dual Lure System Japanese Beetle Bag Trap",
                        "img": "https://www.catchmaster.com/cdn/shop/files/Shopify_Product_Images-1_3pack.jpg?v=1746124936&width=990",
                        "url": "https://www.catchmaster.com/products/catchmaster-japanese-beetle-trap-dual-lure-system-for-season-long-protection",
                        "price": "$34.99 USD"
                    },
                    {
                        "title": '3"x5" Double-Sided Yellow Sticky Card Insect Trap',
                    ...
                    {
                        "title": '3"x5" Double-Sided Blue Sticky Card Insect Trap',
                        "img": "https://www.catchmaster.com/cdn/shop/products/Shopify_Product_Images-B0CCGY2RWP_1.webp?v=1746125511&width=990",
                        "url": "https://www.catchmaster.com/products/seventy-two-blue-stickies",
                        "price": "$31.99 USD"
                    },
                    {
                        "title": "Dual Action Sticky Traps for Plants",
                        "img": "https://www.catchmaster.com/cdn/shop/files/ShopifyProductImages-993_1_v1.jpg?v=1732206433&width=990",
                        "url": "https://www.catchmaster.com/products/catchmaster-dual-action-plant-stakes-100-pack",
                        "price": "$14.99 USD"
                    },
                    {
                        ...
                        "url": "https://www.catchmaster.com/products/tree-banding-diy-insect-adhesive-barrier-full-kit",
                        "price": "$39.49 USD"
                    },
                ],
            },
        ...
        // const sectionTitle = document.querySelector('.iv-eliminate-section + .iv-eliminate-section + section');
        // if (
        //     sectionTitle &&
        ...
        // ) {
            ...
            //     sectionTitle.classList.add('iv-dynamic-product-section');

            document.querySelector('.iv-eliminate-section + .iv-eliminate-section + section').insertAdjacentHTML('beforebegin', `
                <div class="iv-product-Carousel page-width-desktop">
                    <div class="iv-heading"> 
                        <h2>KEEP YOUR FAMILY SAFE FROM PESTS THIS SUMMER</h2>
                    ...
                    <div class="iv-product-btn-wrapper">
                        <a href="/collections/rats-mices" class="iv-shop-all-btn">Shop all rodent traps</a>
                    </div>
                </div>
            `);
            // }
        ...
        function renderProducts(products, category) {
            ...
            const categoryUrls = {
                'Rodent': 'https://www.catchmaster.com/collections/rats-mice',
                'Fly & Gnat': '/collections/flying-insects?sort_by=best-selling&filter.p.m.custom.pest=Fly+%26+Gnat',
                'Fly Lights': '/collections/vector-the-fly-light-trap-at-the-end-of-your-fly-problem',
                'Crop Insects': '/collections/crop-insects',
                'Spiders': '/collections/spider',
                'Ants': '/collections/ant-control-solutions'
            };
