function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-revamp-homepage')) {
        ...
        if(!document.querySelector('.iv-hero-sec')){
            document.querySelector('#MainContent').insertAdjacentHTML('afterbegin', `<h1 class="iv-main-title">Welcome to Catchmaster! The Leader in Glue-Based Pest Control</h1><div class="iv-hero-sec-new iv-hero-desktop">
