function loadTestCode() {
    if (!document.body.classList.contains('iv-revamp-homepage')) {
        document.body.classList.add('iv-revamp-homepage');
        ...
        if(!document.querySelector('.iv-hero-sec')){
            document.querySelector('#MainContent').insertAdjacentHTML('afterbegin', `<div class="iv-hero-sec-new iv-hero-desktop">
                <div class="page-width iv-container">
                    <div class="iv-hero-sec-new-inner">
                        <a class="iv-hero-sec-new-inner-first" href="https://www.catchmaster.com/collections/rats-mice">
                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1763383372/Catchmaster/RevampHomepageLayout/Homepage_Hero_bannerDesktop.png" alt="Hero img" />
                        </a>
                        <a class="iv-hero-sec-new-inner-sec" href="https://www.catchmaster.com/collections/gnat-traps">
        ...
        var addTextInterval = setInterval(function(){
            if(document.querySelectorAll('div:has(.tabs-slider-product-Carousel)').length > 0){
                ...
                // document.querySelector('#yotpo-reviews-carousel-widget h2').insertAdjacentHTML('afterend',`<p>We Want to Hear From You Too!</p>`);
                ...
                <div class="container page-width">
                    ...
                    <div class="itemsSolutions">
                        <div class="item">
                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1763583492/Catchmaster/RevampHomepageLayout/CM-Pest_Solution-1.png" alt="Pest Solutions Image">
                            <div class="itemContent">
                                <h2>CATCHMASTER GLUE: PEST-STOPPING POWER</h2>
                        ...
                        <div class="item">
                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1763583491/Catchmaster/RevampHomepageLayout/CM-Pest_Solution-2.png" alt="Pest Solutions Image">
                            <div class="itemContent">
