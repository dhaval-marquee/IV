function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-instantQuote')) {
        ...
        jQuery('form fieldset[data-step="2"]').addClass('moving-from-to');
        jQuery('form fieldset[data-step="3"]').addClass('moving-from-to');
        jQuery('form fieldset[data-step="4"]').addClass('moving-from-to');
