function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-QuotePage')) {
        ...
        document.querySelector('.iv-QuotePage .nav-toggle').insertAdjacentHTML('beforebegin', `<div class="iv-phone-icon" bis_skin_checked="1">
        ...
        const logoLink = document.querySelector('.iv-QuotePage a[href="/home"] img[alt="Allied Logo"]');
