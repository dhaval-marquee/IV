function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-thanks-number')) {
        ...
        if(ivDesktopNumber) {
            ivDesktopNumber.innerText = '(866) 992-1062';
            ivDesktopNumber.setAttribute('href', 'tel:(866) 992-1062');
        }
        if(ivMobileNumber && ivMobileNumberNav) {
            ivMobileNumber.innerText = '(866) 992-1987';
            ivMobileNumber.setAttribute('href', 'tel:(866) 992-1987');
            ivMobileNumberNav.setAttribute('href', 'tel:(866) 992-1987');
        }
        ...
        var htmlCode = `<div class="iv-number-new iv-number-new-v4">
            <p> 
                ...
                <a class="iv-phone-desktop" href="tel:(866) 992-1062">Call Now: (866) 992-1062</a> 
                <a class="iv-phone-mobile" href="tel:(866) 992-1987">Call Now: (866) 992-1987</a> 
            </p>
