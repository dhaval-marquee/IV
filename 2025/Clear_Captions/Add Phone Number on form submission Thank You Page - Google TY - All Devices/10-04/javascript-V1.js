function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-thanks-number')) {
        ...
        var htmlCode = `<div class="iv-number-new iv-number-new-v1">
            <p> 
                A sales support representative should be calling you within the next 15-30 minutes (7AM to 7PM Pacific). If you would like to get in touch sooner, please call
                <a class="iv-phone-desktop" href="tel:(866) 992-1062">(866) 992-1062.</a> 
                <a class="iv-phone-mobile" href="tel:(866) 992-1987">(866) 992-1987.</a> 
            </p>
