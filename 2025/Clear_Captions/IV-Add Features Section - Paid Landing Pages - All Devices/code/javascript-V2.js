function loadTestCode() {
    if (!document.body.classList.contains("iv-feature-step")) {
        ...
        <div class="iv-container">
            <h2 class="fusion-title-heading title-heading-center fusion-responsive-typography-calculated"><p>Key features of your <span class="title-italic"> captioning phone</span></p></h2>
