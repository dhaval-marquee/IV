function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-thanks-number')) {
        ...
        var ivDesktopNumber = document.querySelector('.iv-thanks-number header .header-nav .header-nav-call-now span').innerText;
        var ivMobileNumber = document.querySelector('.iv-thanks-number header .header-nav-mobile-menu .header-nav-mobile-menu-phone a').innerText;

        var htmlCode = `<div class="iv-number-new iv-number-new-v4">
            <p> 
                ...
                <a class="iv-phone-desktop" href="tel:${ivDesktopNumber}">Call Now: ${ivDesktopNumber}</a> 
                <a class="iv-phone-mobile" href="tel:${ivMobileNumber}">Call Now: ${ivMobileNumber}</a> 
            </p>
