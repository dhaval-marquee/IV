    ...
    if (!jQuery('body').hasClass('howItWorkIV')) {
        ...
        jQuery.ajax({
            ...
            success: function (response) {
                ...
                if (document.querySelectorAll('.fusion-title-4.fusion-no-small-visibility h4').length > 0 && document.querySelectorAll('.fusion-title-3.fusion-no-large-visibility h4').length > 0) {
                    var DText = jQuery('.fusion-title-4.fusion-no-small-visibility h4').text();
                    var MText = jQuery('.fusion-title-3.fusion-no-large-visibility h4').text();

                    var contactNumberD = DText.match(/\d{3}-\d{3}-\d{4}/);
                    var contactNumberM = MText.match(/\d{3}-\d{3}-\d{4}/);

                    jQuery('#dynamicNumber').eq(0).append(
                        `<span class="for-desktop">${contactNumberD}</span><span class="for-mobile">${contactNumberM}</span>`
                    );
                } else if (document.querySelectorAll('.fusion-title-3.fusion-no-small-visibility h4').length > 0 && document.querySelectorAll('.fusion-title-4.fusion-no-large-visibility h4').length > 0) {
                    var DText = jQuery('.fusion-title-3.fusion-no-small-visibility h4').text();
                    var MText = jQuery('.fusion-title-4.fusion-no-large-visibility h4').text();
