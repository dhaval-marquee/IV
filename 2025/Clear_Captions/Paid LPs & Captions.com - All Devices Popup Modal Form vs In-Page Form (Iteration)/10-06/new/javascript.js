    ...
    if (!document.body.classList.contains('iv-popup')) {
        ...
        if (headings.length > 1) {
            ...
            if (window.matchMedia("(max-width: 991.98px)").matches) {
                var  text = headings[1].textContent;
            } else {
                var  text = headings[2].textContent;
            }
        ...
        document.querySelectorAll('ul#menu-lp_menu li')[2].insertAdjacentHTML('afterend', `<li class="callNow">
            <div class="header-nav-call-now">
                <div>
                Call now<br>
        ...
        document.querySelector('nav button.awb-menu__m-toggle > span').insertAdjacentHTML('beforebegin', `<a href="tel:${contactNumber}" class="iv-nav-call"><img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1733218175/ClearCaptions/phone-orange-icon.png" alt="Call us"><span class="iv-call-text">Call us</span></a>`);
        ...
        if (heading) {
            ...
            if(heroImages && rightPhone){
                rightPhone.appendChild(heroImages).insertAdjacentHTML('afterend', `<a href="javascript:void(0)" class="iv-button iv-popup-button iv-button-white">Get My Phone</a>`);
...
let checkCondition = setInterval(function () {
    if (document.querySelectorAll('ul#menu-lp_menu li').length > 0) {
