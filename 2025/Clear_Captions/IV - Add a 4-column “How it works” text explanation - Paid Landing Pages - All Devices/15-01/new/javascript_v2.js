function loadTestCode() {
    ...
    vwo_$("SPAN:tm('How It Works'):nth-parent(1)").vwoAttr({"href":"#workTitle"});
    ...
    if (!jQuery('body').hasClass('howItWorkIV')) {
        ...
        jQuery('#form').after(`<section class="howItWorkSection">
            ...
            <a href="#test" class="awb-menu__main-a awb-menu__main-a_regular" tabindex="-1"><span class="menu-text">How It Works</span></a>
        </section>`);
    ...
    document.addEventListener('DOMContentLoaded', function() {
         // Select the anchor tag within the menu item with id "menu-item-4033"
        var howItWorksLink = document.querySelector('#menu-item-4033 a');

         if (howItWorksLink) {
        // Update the href to point to the "workTitle" element
        howItWorksLink.href = '#workTitle';
         }
});
        ...
        document.addEventListener('click', function(e) {
            e.preventDefault();
            if (e.target.id === 'workTitle') {
                document.querySelector('#menu-item-4033 a').click()
            }
        }); 
    }
}
