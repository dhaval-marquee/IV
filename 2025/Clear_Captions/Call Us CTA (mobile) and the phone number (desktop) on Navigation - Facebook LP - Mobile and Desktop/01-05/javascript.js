function headerNumberDesktop() {
    if (!jQuery("body").hasClass("header-menu")) {
        ...
        document.querySelectorAll(".fusion-builder-row ul li")[0].insertAdjacentHTML("beforebegin", `<li class="menu-item menu-item-type-custom menu-item-object-custom awb-menu__li awb-menu__main-li awb-menu__main-li_regular call-menu">
            <div class="phone-number">
                <span>Call now<a href="tel:+1-866-631-2937">1-866-631-2937</a></span>
            </div>
        </li>`);

        var runCodeInterval = setInterval(function(){
            if(document.querySelectorAll('.fusion-builder-row nav button').length > 0){
                clearInterval(runCodeInterval)
                document.querySelector(".fusion-builder-row nav button").insertAdjacentHTML("beforebegin", `<div class="phone-number">
                <a href="tel:+1-866-932-5606">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:a="http://ns.adobe.com/AdobeSVGViewerExtensions/3.0/" version="1.1" x="0px" y="0px" width="15px" height="25px" viewBox="0 0 233 309" enable-background="new 0 0 233 309" xml:space="preserve">
                        <defs>
                        </defs>
