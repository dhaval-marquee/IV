function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-free-shipping')) {
        ...
        <div class="iv-shipping-content">
            ...
            <p>Available to all registered customers who spend at least $139.</p>
        ...
        function updateShippingInfo() {
            ...
            var totalAmountElem = document.querySelector('[test-id="estimated-total"] dd.summary-price__value-row p.summary-price__value');
