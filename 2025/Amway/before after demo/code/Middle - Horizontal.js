function beforeAfter() {
    if (!document.querySelector('body').classList.contains('before_after_demo')) {
        ...
        document.querySelectorAll('.amw-content-component__tiles-container')[2].closest('.amw-content-component').style.display = 'none';
        document.querySelectorAll('.amw-content-component__tiles-container')[3].closest('.amw-content-component').style.display = 'none';


        document.querySelectorAll('.amw-content-component__tiles-container')[2].closest('.amw-content-component').insertAdjacentHTML('beforebegin',`<div class="clear amw-content-component amw-content-component--extended before-after-section">
            <div class="amw-content-component__title-wrapper" style="text-align: ;">
                <h2 class="amw-content-component__title"></h2>
                <h3 class="title-medium-style" style="text-align: center;">See the Results for Yourself</h3>
                <div class="amw-content-component__text">
                    <div style="text-align: center;">The proof is in the pictures.</div>
                </div>
            </div>
