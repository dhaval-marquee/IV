function beforeAfter() {
    if (!document.querySelector('body').classList.contains('before_after_demo')) {
        ...
        document.querySelector('#productPageAccordion').closest('.yCmsContentSlot').insertAdjacentHTML('beforebegin',`<div class="clear amw-content-component amw-content-component--extended before-after-section">
