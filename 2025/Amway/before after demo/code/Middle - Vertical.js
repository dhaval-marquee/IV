function beforeAfter() {
    if (!document.querySelector('body').classList.contains('before_after_demo')) {
        ...
        document.querySelector('body').classList.add('before_after_demo_v2');

        document.querySelectorAll('.amw-content-component__tiles-container')[2].style.display = 'none';
        document.querySelectorAll('.amw-content-component__tiles-container')[3].style.display = 'none';
