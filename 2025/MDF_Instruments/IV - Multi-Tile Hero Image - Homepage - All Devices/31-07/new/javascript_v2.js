    ...
    if (!jQuery('body').hasClass('homepage_iv')) {
        ...
        jQuery('main > section').eq(0).after(`<section class="slider_section collectionSlider">
            <div class="imgWrapper onlyDesk">
                <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1753947164/MDF_Instruments/MultiTileHeroBg_v2.jpg" alt="MultiTile Hero Bg">
                <div class="slideshow__slide-content    place-self-center text-center sm:place-self-center sm:text-center sectionContent" style="--text-color: 255 255 255; color: rgb(var(--text-color));--border-color: var(--text-color) / 0.15;">
                            <div class="prose"><p class="h6"><strong>$20 off + Free Gifts Worth $80</strong></p><p class="h1"><strong>LIMITED TIME SALE</strong></p><div class="button-group justify-center sm:justify-center">
                <a class="button button--outline" style="--button-background: 255 255 255;--button-outline-color: 255 255 255;--button-text-color: 255 255 255;" href="https://mdfinstruments.com/collections/procardial-titanium-mprints">SHOP NOW</a></div></div>
            </div>
            </div>
            <div class="sliderWrapper onlyMobile">
                <div class="slider">
                    <div class="slide">
                        <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1753947164/MDF_Instruments/StethoscopesDark.png" alt="Stethoscopes">
                    </div>
                    <div class="slide">
            ...
            <div class="slideshow__slide-content place-self-center text-center sm:place-self-center sm:text-center sectionContent" style="--text-color: 255 255 255; color: rgb(var(--text-color));--border-color: var(--text-color) / 0.15;">
                <div class="prose">
                    <p class="h6"><strong>$20 off + Free Gifts Worth $80</strong></p>
                    <p class="h1"><strong>LIMITED TIME SALE</strong></p>
