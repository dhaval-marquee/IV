    ...
    if (!document.querySelector('body').classList.contains('iv-guide-tiles')) {
        ...
        const ivPromotilesContent = `<div class="iv-guide-tiles-box">
                                        <div class="iv-guide-bg">
                                            <img class="iv-guide-img-desktop" src="https://res.cloudinary.com/ignite-visibility/image/upload/v1765600507/MDF_Instruments/MDFToolKitFullSingleImage.png" alt="MDF Tool Kit">
                                        </div>            
