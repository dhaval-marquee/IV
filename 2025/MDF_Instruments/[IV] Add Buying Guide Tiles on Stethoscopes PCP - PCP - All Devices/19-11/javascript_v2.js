function loadTestCode() {
    if (!document.body.classList.contains('iv-guide-tiles')) {
        document.body.classList.add('iv-guide-tiles');
        ...
        const ivPromotilesContent = `<div class="iv-guide-tiles-box">
                                        <div class="iv-guide-bg">
                                            <img class="iv-guide-img-desktop" src="https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/MDF_Instruments/BuyingGuide_Tiles_v2_desktop.jpg" alt="" />
                                            <img class="iv-guide-img-mobile" src="https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/MDF_Instruments/BuyingGuide_Tiles_v2_mobile.jpg" alt="" />
                                        </div>            
                                        <div class="iv-guide-content">
                                            <h3 class="iv-guide-title">😮 Treat Yourself, and Your Patients!</h3>
                                            <div class="iv-guide-inner">Find the right stethoscope for you (and your patients)!</div>
                                            <a class="iv-guide-cta" href="#">Use The MDF Buyer’s Guide</a>
                                        </div>
                                    </div>`;
