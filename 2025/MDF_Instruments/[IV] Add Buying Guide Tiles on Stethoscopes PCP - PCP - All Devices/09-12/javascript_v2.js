    ...
    if (!document.querySelector('body').classList.contains('iv-guide-tiles')) {
        ...
        const ivPromotilesContent = `<div class="iv-guide-tiles-box">
                                        <div class="iv-guide-bg">
                                            <img class="iv-guide-img-desktop" src="https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/MDF_Instruments/mdf_Tool_KitFull-small.png" alt="MDF Tool Kit">
                                            <img class="iv-guide-img-mobile" src="https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/MDF_Instruments/mdf_Tool_Kit.png" alt="MDF Tool Kit">
                                        </div>            
