    ...
    if (!document.querySelector('body').classList.contains('iv-guide-tiles')) {
        ...
        const ivPromotilesContent = `<div class="iv-guide-tiles-box">
                                        <div class="iv-guide-bg">
                                            <img class="iv-guide-img-desktop" src="https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/MDF_Instruments/BuyingGuide_Tiles_v2_desktop-V2.jpg" alt="" />
                                            <img class="iv-guide-img-mobile" src="https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/MDF_Instruments/BuyingGuide_Tiles_v2_mobile-V2.jpg" alt="" />
                                        </div>            
                                        <div class="iv-guide-content">
                                            <h3 class="iv-guide-title">🎁 Save when you buy our bundle this holiday season!</h3>
