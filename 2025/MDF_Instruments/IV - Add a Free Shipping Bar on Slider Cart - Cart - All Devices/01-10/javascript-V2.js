function loadTestCode() {
    if (!document.body.classList.contains("iv-slider-cart")) {
        document.body.classList.add("iv-slider-cart");
        ...
        const observer = new MutationObserver(() => {
            ...
            //| ---------------------------------------------------------------- |
            const shippingGoal = 150; // Change this to 125 or 150 when needed   |
            //|----------------------------------------------------------------- |
