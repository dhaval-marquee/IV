function loadTestCode() {
    ...
    if(cartDrawer){
        ...
        // const boxElement = document.querySelector('.iv-puresona-on-cart .complementary-products__header.complementary-products__header--align-start');

        // if (freeCasenote && boxElement && boxElement.parentNode) {
        //     const alreadyMoved = boxElement.previousElementSibling === freeCasenote;
        //     if (!alreadyMoved) {
        //         boxElement.parentNode.insertBefore(freeCasenote, boxElement);
        //     }
        // }
