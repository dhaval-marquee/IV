function loadTestCode() {
    if (!document.body.classList.contains('iv-promo-tiles-titanium', 'iv-promo-tiles-titanium-v2')) {
        document.body.classList.add('iv-promo-tiles-titanium', 'iv-promo-tiles-titanium-v2');
