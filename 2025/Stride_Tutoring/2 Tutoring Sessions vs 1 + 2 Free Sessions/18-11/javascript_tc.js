...
function loadTestCode() {
    ...
    if (!document.getElementById('iv-style')) {
        ...
        .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > span { box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; font-size: 0; max-width: 280px; margin: auto; padding: 12px; width: 100%; }
        ...
        @media (max-width: 767.98px) {
            ...
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > span{max-width: 206px;padding: 6px;}
