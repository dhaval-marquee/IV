function loadTestCode() {
    ...
    if (!document.getElementById('iv-style')) {
        ...
        .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button { width: 100%; max-width: 744px; box-shadow: 0 3px 10px rgba(0, 0, 0, .5); gap: 12px; padding: 5px 5px 20px 5px; margin-bottom: 16px; }
        .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div { gap: 12px; }
        .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div span { font-size: 28px;line-height: 28px;padding: 24px 26px;align-items: center;display: flex;top: 4px;right: 4px;background-color: #ED1F0D;border-color: #ED1F0D;color: #fff;margin-left: auto;}
        .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div > p { display: none; }
        .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div > img { max-width: 182px; }
        .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div > img + h3 {font-size: 36px;}
        .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div > img + h3 + div {font-size: 20px;}
        .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > span { box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; font-size: 0; max-width: 328px; margin: auto; padding: 16px; width: 100%; }
        .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > span:not([disabled])::before { content: 'Get Started!'; font-size: 20px; font-weight: 400; }
        ...
        .iv-1-hour-option-in-tutoring button > div .lineThroughWrapper h3 { font-size: 26px; }
        ...
        .iv-1-hour-option-in-tutoring main .buttonWrapper button::before {content: '';background-image: url(https://res.cloudinary.com/ignite-visibility/image/upload/v1763363363/StrideTutoring/K12_badgeOffer.png);background-repeat: no-repeat;background-size: contain;position: absolute;top: -12px;left: -44px;height: 100px;width: 280px;}
        ...
        @media (max-width: 1199.98px) {
            ...
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button {padding: 5px 10px 20px 10px;}
            .iv-1-hour-option-in-tutoring main .buttonWrapper button::before {top: -8px;left: -32px;width: 200px;}
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div {gap: 15px;}
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div span { font-size: 22px;line-height: 28px;padding: 22px;}
        }
        @media (max-width: 991.98px) {
            .iv-1-hour-option-in-tutoring main .buttonWrapper button::before{top: -7px;left: -24px;width: 156px;height: 70px;}
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div span { font-size: 16px; line-height: 27px; padding: 18px 25px; }
            .iv-1-hour-option-in-tutoring .iv-left-box h2,
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div > img + h3 {font-size: 32px;line-height: normal;}
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div > img {max-width: 150px;}
        ...
        @media (max-width: 767.98px) {
            ...
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div span{font-size: 20px;padding: 16px 18px;}
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div > img {max-width: 140px;}
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div > img + h3 {font-size: 27px;}
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > div > img + h3 + div { font-size: 15px;}
            .iv-1-hour-option-in-tutoring button > div .lineThroughWrapper h3 {font-size: 18px;}
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > span{max-width: 226px;padding: 10px;}
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button > span:not([disabled])::before {font-size: 14px;}
            .iv-1-hour-option-in-tutoring .iv-target-flexwrap div > button {max-width: 330px; margin: 0 auto 15px; }
            .iv-1-hour-option-in-tutoring main .buttonWrapper button::before {top: -10px;left: -33px;width: 216px;}
        }
    ...
    // Steps block
    if (!document.querySelector('.iv-left-box') && document.querySelector('.iv-packages')) {
    ...
    if (!document.querySelectorAll('.buttonWrapper button').length > 0) {
    ...
    if (document.querySelector('.iv-target-flexwrap') && document.querySelector('.buttonWrapper')) {
