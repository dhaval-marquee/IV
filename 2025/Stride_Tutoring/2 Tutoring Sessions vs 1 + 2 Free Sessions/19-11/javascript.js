function loadTestCode() {
    ...
    if (!document.getElementById('iv-style')) {
        ...
        .iv-buy1-hour-option-in-tutoring .iv-target-flexwrap div > button > div > img { max-width: 368px; padding: 20px 0px;}
        ...
        .iv-buy1-hour-option-in-tutoring .iv-target-flexwrap div > button > span { box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; font-size: 0; max-width: 320px; margin: auto; padding: 16px; width: 100%; }
        ...
        @media (max-width: 767.98px) {
            ...
            .iv-buy1-hour-option-in-tutoring main .buttonWrapper button::before {top: -10px;left: -33px;width: 216px;}
        }
