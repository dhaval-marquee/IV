function loadTestCode() {
    ...
    if (document.querySelector('.iv-price-bar-full')) {
        ...
        var headerHeights = document.querySelector('header').offsetHeight;
        var timeHeights = document.querySelector('.iv-price-bar-main > div').offsetHeight;
        var storeHeights = headerHeights + timeHeights + 10

        var section = document.querySelector('.iv-mob-filter-section');
        var stickyOffset = section.offsetTop - storeHeights; 
