    ...
    if (!document.body.classList.contains('hero_iv')) {
        ...
        if (mainContent) {
            ...
            if (heroSec) {
                ...
                const paragraph = heroSec.querySelector('.nectar-responsive-text p');
                if (paragraph) {
                    paragraph.textContent = 'Discover a learning experience tailored to your child’s needs, with access to top-tier tutors from the comfort of home.';
                }
