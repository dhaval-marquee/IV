function loadTestCode() {
    if (!jQuery('body').hasClass('hero_iv')) {
        ...
        jQuery('.hero_iv .main-content .hero-sec .nectar-highlighted-text h1').html(`Start Your Child’s Path to <em class="animated">Academic Excellence<svg class="nectar-scribble basic-underline" viewBox="-400 -55 730 60" preserveAspectRatio="none"><path style="animation-duration: 1.8s;" d="m -383.25 -6 c 55.25 -22 130.75 -33.5 293.25 -38 c 54.5 -0.5 195 -2.5 401 15" stroke="#fd762b" pathLength="1" stroke-width="20" fill="none"></path></svg></em> Today`);

        jQuery(".hero_iv .main-content .hero-sec .nectar-highlighted-text h2").html(`Start Your Child’s Path to <em class="animated">Academic Excellence<svg class="nectar-scribble basic-underline" viewBox="-400 -55 730 60" preserveAspectRatio="none"><path style="animation-duration: 1.8s;" d="m -383.25 -6 c 55.25 -22 130.75 -33.5 293.25 -38 c 54.5 -0.5 195 -2.5 401 15" stroke="#fd762b" pathLength="1" stroke-width="20" fill="none"></path></svg></em> Today`
        );
