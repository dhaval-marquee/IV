function changeFunctionNameToTestName() {
    if (!jQuery('body').hasClass('heroBullet-iv')) {
        ...
        jQuery('.heroBullet-iv section.oxy-video-background h1').html('Premium Coworking Workspaces<br> Without Long-term Commitments');
        jQuery('.heroBullet-iv section.oxy-video-background h1').after(`<ul>
            <li>Scalable options for teams of all sizes.</li>
