function loadTestCode() {
    if (!document.querySelector('body').classList.contains('contactInfoIV')) {
        ...
        $('.contactInfoIV .productDetailsBox h4.productTitle').after('<div class="address-wrapper"></div>');
        $('.address-wrapper').load(locationUrl + ' .pss-facility__content-address .pss-link span');
