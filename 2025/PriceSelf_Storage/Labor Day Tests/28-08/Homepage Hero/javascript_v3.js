function loadTestCode() {
    if (!document.querySelector('body').classList.contains('homepageIV')) {
        ...
        jQuery('.homepageIV .pss-hero__search input#txtHomeSearch').attr('placeholder', 'Enter City or Zip').attr('aria-label', 'Search storage units by city or zip code');
        
        document.querySelector('.homepageIV .pss-hero .pss-row2').insertAdjacentHTML('afterend', `<div class="pss-row2 onlyDesktop" role="group" aria-labelledby="promotionHeading">
