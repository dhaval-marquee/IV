        ...
        <div class="iv-security-banner-section">
            <div class="iv-security-banner-inner">
                <h3 class="iv-security-banner-info">
                    Labor Day Sale Up To <span class="highlight-text">50%<a href="javascript:;" class="pss-hero__promotion-disclaimer-internal-pages" id="toggle-disclaimer-symbol" role="button" onclick="toggleDisclaimer(event)" aria-label="Symbol for showing general promotion disclaimer">*</a> Off</span> Monthly Rent
                </h3>
            </div>
        </div>`;
