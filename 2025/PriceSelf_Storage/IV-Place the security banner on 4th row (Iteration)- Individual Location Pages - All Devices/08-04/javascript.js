        ...
        <div class="iv-security-banner-section">
            <div class="iv-security-banner-inner">
                <div class="iv-banner-img">
                    <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1744022938/PriceSelfStorage/DarkBlue.png" alt="Security banner image">
                </div>
                <div class="iv-banner-content">
                    ...
                    <p class="iv-banner-desc">At Price Self Storage, we take securing your belongings seriously.</p>
                </div>  
            </div>
        </div>`;
