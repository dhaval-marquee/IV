        ...
        function testUpdates() {
            ...
            rightBoxes.forEach(function(eachBox) {
                ...
                if (ivHeading && ivHeading.innerText === 'LOCK IN TODAY\'S DEAL!') {
                    ...
                    ivHeading.style.textAlign = 'left'; 
                }

                const ivPromoOption = document.querySelector('.iv-locationPage .pss-unit-list__item .pss-promo-row3');
                if (ivPromoOption) {
                    ivPromoOption.style.display = 'none';
                }
