            ...
            rightBoxes.forEach(function(eachBox) {
                ...
                promoHeadings.forEach(function(promoHeading) {
                    if (promoHeading.innerText === "LOCK IN TODAY'S DEAL!") {
                        ...
                        promoHeading.style.textAlign = 'left'; 
                    }
                });
                ...
                const ivPromoOptions = document.querySelectorAll('.iv-locationPage .pss-unit-list__item .pss-promo-row3');
                ivPromoOptions.forEach(option => {
