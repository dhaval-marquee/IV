function loadTestCode() {
    if (!document.querySelector('body').classList.contains('homepageIV')) {
        ...
        function runCode() {
            ...
            document.querySelector('.homepageIV .pss-hero .pss-row1+.pss-row2').insertAdjacentHTML('afterend', '<div class="iIconText"><p><img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1749463673/PriceSelfStorage/i_icon.svg">New customers only. Restrictions and fees apply.</p></div>');
