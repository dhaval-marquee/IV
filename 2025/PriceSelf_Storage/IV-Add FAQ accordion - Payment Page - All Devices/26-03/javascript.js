        ...
        const faqHTML = `<section class="accordion-section">
            <div class="accordion-wrapper">
                ...
                <div class="accordion-left">
                    ...
                    <div class="accordion-item">
                        <div class="accordion-item-title">Implementation Hypothesis</div>
                        <div class="accordion-item-description">
                            <p>Clear move-in policy details may increase user progression if aligned with their needs.</p>
                            <div class="accordion-animation"></div>
                        </div>
                    </div>
                </div>
