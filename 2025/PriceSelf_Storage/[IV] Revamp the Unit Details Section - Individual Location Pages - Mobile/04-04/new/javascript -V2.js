function loadTestCode() {
    if (!jQuery('body').hasClass('iv-locationPage iv-locationChecklist iv-locationPage-v2')) {
        jQuery('body').addClass('iv-locationPage iv-locationChecklist iv-locationPage-v2');
                ...
                document.querySelectorAll('.pss-unit-list__collapse-container-promo-box-main').forEach(function(promoRow) {
                    ...
                    if (targetButton && !promoRow.classList.contains('cloned')) {
                        ...
                        if (!existingClone) {
                            ...
                            targetButton.insertAdjacentElement('afterend', clonedPromoRow);
