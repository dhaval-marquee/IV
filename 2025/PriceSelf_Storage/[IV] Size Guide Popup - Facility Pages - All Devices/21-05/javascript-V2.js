function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-guide-popup')) {
        ...
        const desktopHoverImg = document.querySelectorAll('.size-guide .pss-link');
        const imageHoverGif = document.querySelector('.size-guide-box .tooltip-gif-container img');
        desktopHoverImg.forEach(() => {
