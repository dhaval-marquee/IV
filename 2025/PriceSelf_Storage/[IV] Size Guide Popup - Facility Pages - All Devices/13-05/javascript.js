        ...
        const ivPopupTargets = document.querySelectorAll('.size-guide .pss-link, .size-guide-mobile');
            ivPopupTargets.forEach((popupBtn) => {
                ...
                popupBtn.addEventListener('click', () => {
                    ...
                    // Auto-select the correct tab and size using DOM lookup
                    ...
                    if (foundTabGroup) {
                        ...
                        // Select correct size tab inside the tab group
                        setTimeout(() => {
                            const matchingSizeBtn = document.querySelector(`.iv-pss-tabs-size[data-group="${foundTabGroup}"] .iv-pss-tab-size`);
                            if (matchingSizeBtn) {
