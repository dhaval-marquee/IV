    ...
    if (!document.querySelector('body').classList.contains('iv-guide-popup')) {
        ...
        ivPopupTargets.forEach((popupBtn) => {
            ...
            popupBtn.addEventListener('click', () => {
                ...
                // STRONGER MATCHING: Normalize and check exact key
                ...
                // Determine tab group
                if (sizeTextForTab?.includes('large')) {
                    tabToShow = 'large';
                } else if (sizeTextForTab?.includes('medium')) {
                    tabToShow = 'medium';
                } else if (sizeTextForTab?.includes('small')) {
                    tabToShow = 'small';
                }
