        ...
        const heroContent = `
            <div class="from-left col-12 col-lg-6">
                ...
                <ul class="from-left-list">
                    <li>Reduce denials and speed up payments.</li>
                    <li>Automate claims and eligibility verification.</li>
                    <li>Streamline billing and patient registration.</li>
                    <li>Integrate easily with EHR and billing systems.</li>
                </ul>
            </div>`;
