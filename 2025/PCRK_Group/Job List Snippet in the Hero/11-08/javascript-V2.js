function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-snippet-hero', 'iv-snippet-hero-v2')) {
        ...
        const ivRightContent = `<div class="iv-right-hero">
            <a href="https://recruiting.paylocity.com/recruiting/jobs/All/82c2cc31-fe87-4023-ac2b-e0967073cc6b/PCRK-Group"><img class="iv-hero-dsktop-img" src="https://res.cloudinary.com/ignite-visibility/image/upload/f_auto/PCRK-Group/PCRK-Job-List-Snippet.png" alt="PCRK job list snippet"></a>
