function loadTestCode() {
    if (!document.querySelector('body').classList.contains('iv-homepage')) {
        ...
        document.querySelector('.section-benefits + section  a.gb-button + a.gb-button').textContent = 'Apply Now';
        document.querySelector('.section-benefits a.gb-button ').textContent = 'Apply Now';
