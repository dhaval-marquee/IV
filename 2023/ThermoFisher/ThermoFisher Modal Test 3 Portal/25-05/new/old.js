...
$('body').append('<link rel="stylesheet" href="https://www.thermofisher.com/etc.clientlibs/multisitecommons/clientlibs/clientlib-recent_searches_and_suggestions.min.css" type="text/css">')
$('body').append('<link rel="stylesheet" href="https://www.thermofisher.com/etc.clientlibs/allergy/clientlibs/clientlib-site.min.css" type="text/css">');

var header = "https://www.thermofisher.com/allergy/us/en/home.html";
...
$('footer + div').load(header + ' .tfs_footer');
