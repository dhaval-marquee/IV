        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h2>Choose the option that's right for you</h2>
                    <div class="modal_left">
                        ...
                        <div class="btn-solid-primary">
                            <a class="btn close" href="https://www.thermofisher.com/allergy/us/en/blood-testing-allergies/how-to-get-an-allergy-test.html#purchase-test">View testing options</a>
                        </div>
                    </div>
                    <div class="modal_right">
                        ...
                        <div class="btn-solid-primary">
                            <a class="btn close" href="https://www.thermofisher.com/allergy/us/en/get-tested.html">Get started</a>
                        </div>
                    </div>
                </div>
            </div>
