            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="modal_left">
                        <h3 class="text-center">Get a specific IgE blood&nbsp;test</h3>
                        <p>No more waiting. You can decide between either purchasing a lab test or scheduling an appointment. Choose the option that's right for you, today.</p>
                        <div class="btn-solid-primary">
                            <a class="btn" href="https://www.thermofisher.com/allergy/us/en/blood-testing-allergies/how-to-get-an-allergy-test.html#testing-options">View Testing Options</a>
                        </div>
                    </div>
                    <div class="modal_right">
                        <h3 class="text-center">Consult with a healthcare provider&nbsp;first</h3>
                        <p>Do you have questions about a specific IgE blood test? Fill out our symptom tracker, which will generate a comprehensive summary about your symptoms. You can review this with your healthcare provider to decide if a specific IgE blood test is right for you.</p>
                        <div class="btn-solid-primary">
                            <a class="btn" href="https://www.thermofisher.com/allergy/us/en/get-tested.html">View Testing Options</a>
                        </div>
                    </div>
                </div>
            </div>
