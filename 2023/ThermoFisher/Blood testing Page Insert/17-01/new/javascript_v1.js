function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('blood_testing_Page')) {
        bodyEle.classList.add('blood_testing_Page','blood_testing_Page_v1');
        ...
        document.querySelectorAll('.blood_testing.well[data-icon][data-icon-circle] h4 ~ p')[1].remove();
        document.querySelector('.blood_testing.well[data-icon][data-icon-circle] .cmp-button.full-width .btn').classList.add('v1_btn')
