    ...
    if (!document.querySelector('body').classList.contains('home_hero_iv')) {
        ...
        var loadHero1111 = setInterval(function() {
            if (document.querySelectorAll('.home_hero_iv .tp-parallax-wrap').length > 0) {
                ...
                document.querySelector('.rev_slider_wrapper').insertAdjacentHTML('afterend',`<div class="heroSection">
                <div class="heroSectionInner">
                    <div class="heroBox">
                        <span class="goldtext">GOLD STANDARD</span>
                        <h2>AUTO REPAIR SOFTWARE </h2>
            ...
            document.querySelector('.guidance_text').after(document.querySelectorAll('.tp-caption.rev_group .tp-parallax-wrap')[3]);
