                ...
                '<div class="repair_text">'+
                    '<div class="repair_item">'+
                        '<div class="repair_icon">'+
                            '<img src="'+cloudinary+'1searchplusicon.png" alt="Search Plus Icon">'+
                        '</div>'+
                        '<div class="repair_content">'+
                            '<h3>1Search Plus</h3>'+
                            '<p>ProDemand\'s advanced search engine returns targeted results in a user-friendly card format</p>'+
                        '</div>'+
