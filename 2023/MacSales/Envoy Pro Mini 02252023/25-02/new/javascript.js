    ...
    $('.iv_eshop_pdp #pdp-cart__btn-a').before(`<div class="select_wrapper">
        <div class="custom_selectBox">
            ...
            <select onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                ...
                <option value="https://eshop.macsales.com/item/OWC/ENVPMCA02/"> 250 GB </option>
                <option value="https://eshop.macsales.com/item/OWC/ENVPMCA05/"> 500 GB </option>
                <option value="https://eshop.macsales.com/item/OWC/ENVPMCA10/"> 1.0 TB </option>
            </select>
        </div>
    </div>`);
