if(!$('body').hasClass('heroSection')) {
	...
	<a href="#how-to-buy" class="block__margin-top-medium owc-button owc-cta-button block__button block__button-large animate-scroll">Talk With a Pro</a>`);
	...
	var $Interval = setInterval(function () {
		if($('.heroSection .hs-form-private .form-columns-1 [id*="label-message"] > span')) {
			...
			$('.heroSection .jellyfish-contact-form .hs-form-private input[type=submit]').attr('value', 'Talk With a Pro')
		}
	},500);
}