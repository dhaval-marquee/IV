function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('checkout_test')) {
        ...
        $('.ncrt_acc_bil #bFirstName').attr('placeholder', 'First Name');
        $('.ncrt_acc_shi #sFirstName').attr('placeholder', 'First Name');
        $('.ncrt_acc_bil #bLastName').attr('placeholder', 'Last Name');
        $('.ncrt_acc_shi #sLastName').attr('placeholder', 'Last Name');
        $('.ncrt_acc_bil #bPhone').attr('placeholder', 'Phone Number');
        $('.ncrt_acc_shi #sPhone').attr('placeholder', 'Phone Number');
        $('.ncrt_acc_bil #bPhoneExt').attr('placeholder', 'Ext.');
        $('.ncrt_acc_shi #sPhoneExt').attr('placeholder', 'Ext.');
        $('.ncrt_acc_bil #email').attr('placeholder', 'e-mail address');
        $('.ncrt_acc_shi #semail').attr('placeholder', 'e-mail address');
        $('.ncrt_acc_bil #bCompany').attr('placeholder', 'Company (Optional)');
        $('.ncrt_acc_shi #sCompany').attr('placeholder', 'Company (Optional)');
        $('.ncrt_acc_bil #bAddress1').attr('placeholder', 'Address');
        $('.ncrt_acc_shi #sAddress1').attr('placeholder', 'Address');
        $('.ncrt_acc_bil #bCity').attr('placeholder', 'City');
        $('.ncrt_acc_shi #sCity').attr('placeholder', 'City');
        $('.ncrt_acc_bil #bZip').attr('placeholder', 'Zip Code');
        $('.ncrt_acc_shi #sZip').attr('placeholder', 'Zip Code');
        $('.ncrt_acc_shi #altPhone').attr('placeholder', 'Mobile/Other Phone Number');
        $('.ncrt_acc_shi #altPhoneExt').attr('placeholder', 'Ext.');
        ...
        $('.button-wrap #btnSubmitUpdateBtn span').text('Choose Shipping & Payment Type');
        ...
        $('.bCity').before(`<a herf="javascript:void(0)" class="apt_Suite"> Add Apt#, Suite, Floor (optional)</a>`);
        ...
        $('#checkoutBraintreePaymentForm').wrap(`<div class="main_part"><div class="left_part"></div><div class="right_part"></div></div>`);
        ...
        $('#intDutiesBox .ncrt_agree+.ncrt_cm_fieldlabel +.ncrt_cm_desc_n+.ncrt_cm_desc_n+.ncrt_agree').after($('.alidationBox'));
        ...
        //        $('input[name="payment_method_nonce"]').before('<span class="cl_line button"></span>');
        //    }
        // }, 100);
