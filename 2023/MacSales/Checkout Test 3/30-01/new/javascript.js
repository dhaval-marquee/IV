function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('checkout_test')) {
        ...
        $('#SHIPverifiedAddressBox1').before(`<span class="button-wrap">
            <button type="submit" class="ncrt_cm_s_field_button payment_Type" id="btnSubmitUpdateBtn">
                <span class="ncrt_cm_buttonlabel">Choose Shipping &amp; Payment Type</span>
            </button>
        </span>`);
        ...
        $('.bCity').before(`<a herf="javascript:void(0)" class="commercial_Address">+ This is a Business/Commercial Address</a>`);
