function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('bottomPage_Test')) {
        ...
        $(document).ready(function() {
            $('#includesHeading, #reviewHeading, #overviewHeading, #specsHeading, .pdp-compatibility__title-container,.pdp-videos__title-container,.pdp-videos__title-container').click(function(){
              var $this = $(this);
