function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('bottomPage_Test')) {
        bodyEle.classList.add('bottomPage_Test');
        ...
        $(document).ready(function() {
            $('#includesHeading, #reviewHeading, #overviewHeading, #specsHeading, .pdp-compatibility__title-container,.pdp-videos__title-container,.pdp-videos__title-container,#benchmarksHeading').click(function(){
              var $this = $(this);
        ...
        if(document.querySelectorAll('#compatibility-items > div').length == 1 && document.querySelectorAll('#compatibility-items > div')[0].getAttribute('data-code') == 'products') {
          document.querySelector('#compatibility').style.display = 'none';
          document.querySelector('#tab-compatibility').style.display = 'none'
        }
      }
}
loadTestCode();