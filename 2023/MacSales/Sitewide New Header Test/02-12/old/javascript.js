function loadTestCode() {
    ...
    if (!bodyEle.classList.contains(tagClass)) {
        ...
        // Topbar
        var topbarLeft = `<p class="top-left-text">Celebrating 35 years of quality gear and expert support. <a href="/about-us">Watch the video »</a></p>`;
        ...
        // navigation-region
        // var navigationRegion = document.getElementById("navigation-region");
        // var anchorElement = navigationRegion.querySelector("a");
        // anchorElement.textContent = anchorElement.textContent.replace(/\+/g, '/');
        // My Account
        ...
        var subArrowMenu = `<img class="arrow-default" src="//res.cloudinary.com/ignite-visibility/image/upload/v1700281141/macsales/SitewideNewHeaderTest/nav-arrow-right.svg" alt="Arrow" />
                            <img class="arrow-hover" src="//res.cloudinary.com/ignite-visibility/image/upload/v1700287960/macsales/SitewideNewHeaderTest/nav-arrow-right-hover.svg" alt="Arrow" />
                            <img class="arrow-mobile" src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700288822/macsales/SitewideNewHeaderTest/nav-arrow-right-white.svg" alt="Arrow" />`
                    ...
                    <div class="nav-right-menu">
                                ...
                                <ul>
                                        ...
                                        <ul class="nav-sub-menu">
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="/shop/external-storage">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281239/macsales/SitewideNewHeaderTest/externalDrives.svg" />
                                                        </span> 
                                                    ...
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            <li><a href="/shop/thunderbay-flex-8/thunderbolt-3">OWC ThunderBay Flex</a></li>
                                                            <li><a href="/shop/thunderbay-8/thunderbolt-3">OWC ThunderBay 8 </a></li>
                                                            <li><a href="/shop/thunderbay-4/thunderbolt-3-raid-5">OWC ThunderBay 4 </a></li>
                                                            <li><a href="/shop/thunderbay-4-mini/thunderbolt-3">OWC ThunderBay 4 Mini</a></li>
                                                            <li><a href="/shop/owc-flex-1u4">OWC Flex</a></li>
                                                            <li><a href="/shop/express-4m2">OWC Express</a></li>
                                                            <li><a href="/shop/owc-thunderblade">OWC ThunderBlade</a></li>
                                                            <li><a href="/shop/owc-mercury-elite-pro-quad/raid-5">OWC Mercury Elite Pro Quad Raid</a></li>
                                                            <li><a href="/shop/owc-archive-pro">OWC Archive Pro</a></li>
                                                            <li><a href="/shop/owc-gemini">OWC Gemini</a></li>
                                                            <li><a href="/shop/owc-ministack-stx">OWC miniStack STX</a></li>
                                                        </ul>
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="/shop/nas-storage">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281243/macsales/SitewideNewHeaderTest/networkAttachedStorage.svg" />
                                                        </span> 
                                                    ...
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            <li><a href="/shop/storage/Enterprise/jupiter">OWC Jupiter</a></li>
                                                            <li><a href="/shop/jellyfish-nas-storage">OWC Jellyfish</a></li>
                                                        </ul>
                                                        <div class="featured-items">
                                                             <h5 class="nav-title">${featuredTitle}</h5>
                                                            <div class="featured-items-list"></div>
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="/shop/internal_storage/hard_drives_and_SSD">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281240/macsales/SitewideNewHeaderTest/internalDrives.svg" />
                                                        </span> 
                                                    ...
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            <li><a href="/shop/ssd/owc">SSDs</a></li>
                                                            <li><a href="/shop/ssd/owc/mac-pro">Mac Pro SSDs</a></li>
                                                            <li><a href="/shop/hard-drives/3.5-SerialATA">3.5in Drives</a></li>
                                                            <li><a href="/shop/hard-drives/2.5-Notebook">2.5in Drives</a></li>
                                                            <li><a href="/shop/hard-drives/3.5-IDE-ATA">3.5in ATA Drives</a></li>
                                                            <li><a href="/shop/ps4-hard-drive-upgrade-kit">PS4 Drives</a></li>
                                                        </ul>
                                                        <div class="featured-items">
                                                             <h5 class="nav-title">${featuredTitle}</h5>
                                                            <div class="featured-items-list"></div>
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="#">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281239/macsales/SitewideNewHeaderTest/docksConnectivity.svg" />
                                                        </span> 
                                                        <span>Docks & Connectivity</span>
                                                    </a>
                                                    <span class="sub-arrow-icon">${subArrowMenu}</span>
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            <li><a href="#">Thunderbolt Docks</a></li>
                                                            <li><a href="#">Thunderbolt Hubs</a></li>
                                                            <li><a href="#">USB-C Docks</a></li>
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="#">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281241/macsales/SitewideNewHeaderTest/memoryCards.svg" />
                                                        </span> 
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="#">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281240/macsales/SitewideNewHeaderTest/macs.svg" />
                                                        </span> 
                                                        <span>Macs & Apple Gear</span>
                                                    </a>
                                                    <span class="sub-arrow-icon">${subArrowMenu}</span>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="#">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281246/macsales/SitewideNewHeaderTest/batteries.svg" />
                                                        </span> 
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="/shop/software">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281245/macsales/SitewideNewHeaderTest/softwareApps.svg" />
                                                        </span> 
                                                    ...
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            <li><a href="/item/Parallels/PPDPROSUB1Y></a>Parallels</a></li>
                                                            <li><a href="/item/Microsoft/KW900633/">Windows</a></li>
                                                            <li><a href="/shop/softraid">OWC SoftRAID</a></li>
                                                            <li><a href="/shop/macdrive">OWC MacDrive 11  </a></li>
                                                            <li><a href="/item/Diglloyd/OSXTOOLS/">digilloyd</a></li>
                                                        </ul>
                                                        <div class="featured-items">
                                                             <h5 class="nav-title">${featuredTitle}</h5>
                                                            <div class="featured-items-list"></div>
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="/shop/accessories/cables">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281238/macsales/SitewideNewHeaderTest/cables.svg" />
                                                        </span> 
                                                        <span>Cables</span>
                                                    </a>
                                                    <span class="sub-arrow-icon">${subArrowMenu}</span>
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            <li><a href="/shop/cables/lightning">Lightning Cables</a></li>
                                                            <li><a href="/shop/owc-thunderbolt-4-cables">Thnderbolt USB-C Cables</a></li>
                                                            <li><a href="/shop/Thunderbolt/OWC/Thunderbolt-Cables">Thunderbolt 2 Cables</a></li>
                                                            <li><a href="/shop/cables/usb">USB Cables</a></li>
                                                            <li><a href="/shop/cables/usb-c">USB-C Cables</a></li>
                                                            <li><a href="/shop/cables/hdmi">HDMI Cables</a></li>
                                                            <li><a href="/item/OWC/CAT725GRY/">Ethernet Cables</a></li>
                                                            <li><a href="/shop/cables/firewire">FireWire Cables</a></li>
                                                            <li><a href="/shop/cables/audio">Audio Cables</a></li>
                                                            <li><a href="/shop/cables/video">Video Cables</a></li>
                                                            <li><a href="/shop/cables/power">Power Cables</a></li>
                                                        </ul>
                                                        <div class="featured-items">
                                                             <h5 class="nav-title">${featuredTitle}</h5>
                                                            <div class="featured-items-list"></div>
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="#">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281245/macsales/SitewideNewHeaderTest/accessories.svg" />
                                                        </span> 
                                                    ...
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            <li><a href="/shop/accessories">Hand-Picked Accesories</a></li>
                                                            <li><a href="/shop/accessories/tools-toolkits">Tool Kits</a></li>
                                                        </ul>
                                                        <div class="featured-items">
                                                             <h5 class="nav-title">${featuredTitle}</h5>
                                                            <div class="featured-items-list"></div>
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="#">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281241/macsales/SitewideNewHeaderTest/memory.svg" />
                                                        </span> 
                                                        <span>Memory</span>
                                                    </a>
                                                    <span class="sub-arrow-icon">${subArrowMenu}</span>
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            <li><a href="#">Atlas Ultra V90</a></li>
                                                            <li><a href="#">Atlas Ultra CFExpress</a></li>
                                                            <li><a href="#">iMac</a></li>
                                                            <li><a href="#">MacBook</a></li>
                                                            <li><a href="#">MacBook Pro</a></li>
                                                            <li><a href="#">Mac Pro</a></li>
                                                            <li><a href="#">Mac Mini</a></li>
                                                            <li><a href="#">Legacy Mac Memory</a></li>
                                                        </ul>
                                                        <div class="featured-items">
                                                             <h5 class="nav-title">${featuredTitle}</h5>
                                                            <div class="featured-items-list"></div>
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="/shop/expansion-cards/pcie">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281243/macsales/SitewideNewHeaderTest/PCIeExpansion.svg" />
                                                        </span> 
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="#">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281242/macsales/SitewideNewHeaderTest/Mouse.svg" />
                                                        </span> 
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="/shop/specials">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281239/macsales/SitewideNewHeaderTest/deals.svg" />
                                                        </span> 
                                                        <span>Deals</span>
                                                    </a>
                                                    <span class="sub-arrow-icon">${subArrowMenu}</span>
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="/blog/">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281247/macsales/SitewideNewHeaderTest/blog.svg" />
                                                        </span> 
                                                        <span>Blog</span>
                                                    </a>
                                                    <span class="sub-arrow-icon">${subArrowMenu}</span>
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    <a href="#">
                                                        <span class="nav-icon">
                                                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1700281244/macsales/SitewideNewHeaderTest/setting.svg" />
                                                        </span> 
                                                    ...
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            <li><a href="/shop/upgrade-service">OWC Upgrade Service</a></li>
                                                            <li><a href="/upgrades/">Upgrade My Mac</a></li>
                                                            <li><a href="/installvideos">Install Videos</a></li>
                                                        </ul>
                                                        <div class="featured-items">
                                                            <h5 class="nav-title">Featured Items</h5>
                                                            <div class="featured-items-list"></div>
                                                        </div>
                                                    </div>
                                    ...
                                    <li class="nav-mobile-item">
                                        <ul>
                                            ...
                                            <li><a href="/installvideos">Install Videos</a></li>
                                            <li><a href="tel:8002754576">USA 1-800-275-4576</a></li>
                        ...
                        <div class="nav-search">
                            <div class="nav-search-mobile">
                                <svg viewBox="0 0 28 28" width="19" height="19" focusable="false"><use xlink:href="/assets/images/defs.svg#icon-search"></use><title>search</title></svg>
                            </div>
                            <form class="nav-primary__search-form" name="GeneralSearchForm" action="/search/" method="get" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" role="search">
                                <label id="search-label" for="nav-primary-search" class="form__label-visually-hidden">Search</label>
                                <input class="nav-primary__search-input nav-link-menu" id="nav-primary-search" type="text" name="q" value="" placeholder="Search" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false">
        ...
        // Search
        var searchInput = document.querySelector('.nav-search form.nav-primary__search-form input');
        if (searchInput) {
            searchInput.placeholder = 'Search OWC...';
        }
        var navSearchMobile = document.querySelector('.nav-search-mobile');
        var searchForm = document.querySelector('.nav-primary__search-form');
        navSearchMobile.addEventListener('click', function(event) {
          event.stopPropagation();
          toggleActiveClass();
        });
        document.addEventListener('click', function(event) {
          var isClickInsideNavSearchMobile = navSearchMobile.contains(event.target);
          var isClickInsideSearchForm = searchForm.contains(event.target);
          if (!isClickInsideNavSearchMobile && !isClickInsideSearchForm) {
        ...
        subMenuAnchors.forEach(function(anchor) {
            anchor.addEventListener('click', function(event) {
                var isSameAnchor = activeAnchor === anchor;
                subMenuAnchors.forEach(function(menuAnchor) {
                    menuAnchor.classList.remove('active-sub-mega-menu');
                });
                var activeNavMegaMenu = document.querySelector('.nav-mega-menu.active-sub-mega-menu');
                if (activeNavMegaMenu) {
                    activeNavMegaMenu.classList.remove('active-sub-mega-menu');
                }
                if (!isSameAnchor) {
                    anchor.classList.add('active-sub-mega-menu');
