function loadTestCode() {
    ...
    if (!bodyEle.classList.contains(tagClass)) {
        ...
        // cloudinary URL
        const Curl = `https://res.cloudinary.com/ignite-visibility/image/upload`
                                        ...
                                        <ul class="nav-sub-menu">
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    ...
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            <li><a href="/shop/memory-cards/atlas-ultra-sd-v90">Atlas Ultra V90</a></li>
                                                            <li><a href="/shop/memory-cards/atlas-pro-sd-v60">Atlas Pro SD V60</a></li>
                                                            <li><a href="/shop/memory-cards/atlas-ultra-cfexpress">Atlas Ultra CFExpress</a></li>
                                                            <li><a href="/shop/memory-cards/atlas-pro-cfexpress">Atlas Pro CFExpress</a></li>
                                                            <li><a href="/shop/innergize">OWC innergize</a></li>
                                                            <li><a href="/shop/owc-atlas-dual-cfexpress-sd-card-reader">Atlas Dual CFExpress + SD Card Reader</a></li>
                                                            <li><a href="/shop/owc-atlas-dual-sd-card-reader">Atlas Dual SD Card Reader</a></li>
                                                            <li><a href="/shop/owc-atlas-fxr">Atlas FXR CFexpress Card Reader</a></li>
                                                            <li><a href="/item/OWC/TCCFSTRDR/">Atlas CFast Card Reader</a></li>
                                                        </ul>
                                                        <div class="featured-items">
                                                             <h5 class="nav-title">${featuredTitle}</h5>
                                                            <div class="featured-items-list"></div>
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    ...
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            <li><a href="https://eshop.macsales.com/shop/laptop-batteries/macbook-pro">MacBook Pro</a></li>
                                                            <li><a href="https://eshop.macsales.com/shop/laptop-batteries/macbook-air">MacBook Air</a></li>
                                                            <li><a href="https://eshop.macsales.com/shop/laptop-batteries/macbook">MacBook</a></li>
                                                            <li><a href="https://eshop.macsales.com/shop/accessories/portable-usb-power">Portable Power Banks</a></li>
                                                        </ul>
                                                        <div class="featured-items">
                                                             <h5 class="nav-title">${featuredTitle}</h5>
                                                            <div class="featured-items-list"></div>
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    ...
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            <li><a href="/item/Parallels/PPDPROSUB1Y/>Parallels</a></li>
                                                ...
                                                <div class="nav-sub-menu-wrapr">
                                                    ...
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            ...
                                                            <li><a href="/shop/accessories/keyboards">Keyboards</a></li>
                                                            <li><a href="/shop/accessories/Mouse_Mice">Mice + Trackpads</a></li>
                                                            <li><a href="/shop/video/web-cameras">Webcam</a></li>
                                                        </ul>
                                                        <div class="featured-items">
                                                             <h5 class="nav-title">${featuredTitle}</h5>
                                                            <div class="featured-items-list"></div>
