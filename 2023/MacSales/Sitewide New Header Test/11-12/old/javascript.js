            ...
            <div class="splide">
                <div class="splide__track">
                    <ul class="splide__list">
                        ...
                        <li class="splide__slide">
                            <p class="top-left-text">Celebrating 35 years of quality gear and expert support. <a href="/about-us">Watch the video »</a></p>
                        </li>
                                        ...
                                        <ul class="nav-sub-menu">
                                            ...
                                            <li>
                                                <div class="nav-sub-menu-wrapr">
                                                    ...
                                                    <div class="nav-mega-menu">
                                                        <ul>
                                                            <li><a href="/shop/laptop-batteries/macbook-pro">MacBook Pro</a></li>
                                                            <li><a href="/shop/laptop-batteries/macbook-air">MacBook Air</a></li>
                                                            <li><a href="/shop/laptop-batteries/macbook">MacBook</a></li>
                                                            <li><a href="/shop/accessories/portable-usb-power">Portable Power Banks</a></li>
                                                        </ul>
                                                        <div class="featured-items">
                                                             <h5 class="nav-title">${featuredTitle}</h5>
                                                            <div class="featured-items-list"></div>
                                            ...
                                            <li class="none-mega">
                                                <div class="nav-sub-menu-wrapr">
                                                    ...
                                                    <span class="sub-arrow-icon d-none">${subArrowMenu}</span>
                                                </div>
                                            </li>
                                            <li class="none-mega">
                                                <div class="nav-sub-menu-wrapr">
