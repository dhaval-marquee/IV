function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('sidebox_iv')) {
        ...
        var loadCode;
        var userIsFrom = sessionStorage.getItem('auraProX2SubPage');
        // console.log('selectedPage = ' + userIsFrom);

        if(userIsFrom == 'macbook-pro-13-15') {

            var loadCode = "https://eshop.macsales.com/shop/ssd/owc/macbook-pro-retina-display/2013-2014-2015";
            var loadCodeFromThisLocation = loadCode + ' .product-family > .row:nth-child(2)'

        } else if(userIsFrom == 'macbook-air-11-13') {

            var loadCode = "https://eshop.macsales.com/shop/ssd/owc/macbook-air/2013-2014-2015";
            var loadCodeFromThisLocation = loadCode + ' .product-family > .row:nth-child(2)'

        } else if(userIsFrom == 'mac-pro') {

            var loadCode = "https://eshop.macsales.com/shop/ssd/owc/mac-pro/2013";
            var loadCodeFromThisLocation = loadCode + ' .product-family > .row:nth-child(2)'

        } else if(userIsFrom == 'mac-mini') {

            var loadCode = "https://eshop.macsales.com/shop/ssd/owc/mac-mini/2014";
            var loadCodeFromThisLocation = loadCode + ' .product-family > .row:nth-child(8)'

        } else if(userIsFrom == 'imac-27') {

            var loadCode = "https://eshop.macsales.com/shop/ssd/owc/imac-27-inch/2013-2019";
            var loadCodeFromThisLocation = loadCode + ' .product-family > .row:nth-child(2)'

        }
        else if(userIsFrom == 'imac-21.5') {

            var loadCode = "https://eshop.macsales.com/shop/ssd/owc/imac-21.5-inch/2013-2019";
            var loadCodeFromThisLocation = loadCode + ' .product-family > .row:nth-child(2)'

        }
        // console.log(loadCodeFromThisLocation);

        $('.loadNewContent').load(loadCodeFromThisLocation, function() {
