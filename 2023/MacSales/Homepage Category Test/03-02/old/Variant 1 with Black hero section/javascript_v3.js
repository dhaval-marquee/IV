function loadTestCode2() {
    ...
    if (!bodyEle.classList.contains('homepage_Category')) {
        ...
        $('.homepage_Category .nav-primary .nav-primary__nav .nav-primary__links #navigation-upgrades a').html($('.homepage_Category .nav-primary .nav-primary__nav .nav-primary__links #navigation-upgrades a').html().replace('My Upgrades','Upgrade My Mac'));
    }
}
