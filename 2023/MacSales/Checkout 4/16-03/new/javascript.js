function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('checkout_test')) {
        ...
        <span>
            <h3>Order Type:*</h3>
            <input name="orderType" type="radio" class="orderType" id="personalPurchase" value="personalPurchase">
            <label for="personalPurchase">Personal purchase</label>

            <input name="orderType" type="radio" class="orderType" id="businesspurchase" value="businesspurchase" checked>
        ...
        $('.checkout_test #bCompany').attr('required','required');
