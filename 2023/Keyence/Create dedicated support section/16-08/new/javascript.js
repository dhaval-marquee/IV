function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('supportTest')) {
        ...
        document.querySelectorAll('p').forEach(function(title){
            if(title.innerText == 'For Your Support:') {
                title.closest('div').classList.add('yourSupport');
            }
        });
