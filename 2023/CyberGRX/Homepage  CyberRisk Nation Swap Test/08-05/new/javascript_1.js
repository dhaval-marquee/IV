                    ...
                    <div class="tab_iv_tabs">
                        <div class="tab_iv_tabstitle_wrap">
                            ...
                            <button class="tab_iv_tabstitle" data-tab="2">
                                `+IconImage+`
                                <span class="tab_iv_tabstitle_text">Vet & Onboard Vendors</span>
                                <span class="tab_iv_tabstitle_line"></span>
                            </button>
                            <button class="tab_iv_tabstitle" data-tab="3">
                                `+IconImage+`
                                <span class="tab_iv_tabstitle_text">Prioritize Third-Party Risks</span>
                                <span class="tab_iv_tabstitle_line"></span>
                            </button>
                            <button class="tab_iv_tabstitle" data-tab="4">
                                `+IconImage+`
                                <span class="tab_iv_tabstitle_text">Manage Your Cyber Reputation</span>
                                <span class="tab_iv_tabstitle_line"></span>
                            </button>
