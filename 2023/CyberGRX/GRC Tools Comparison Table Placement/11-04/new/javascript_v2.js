function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('redesign_table')) {
        ...
        document.querySelectorAll('.hasCTA a')[0].insertAdjacentHTML('beforebegin','<br><br>');
        ...
        document.querySelectorAll('.redesign_table .hero_left')[0].insertAdjacentHTML('afterbegin',`<table class="cybergrx_table" cellspacing="0">
            <thead class="text-center">
                <tr>
                    <th width="54%"></th>
                    <th width="23%">CyberGRX</th>
                    <th width="23%">GRC Tools <em>Examples: Archer Suite (RSA), IBM Open Pages, Metric Stream, ServiceNow</em></th>
                </tr>
            </thead>
            <tbody>
                <tr>
