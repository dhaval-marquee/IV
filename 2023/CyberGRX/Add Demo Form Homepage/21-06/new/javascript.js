function loadTest() {
    ...
    if (!bodyEle.classList.contains('homeForm_iv')) {
        ...
        document.querySelector('.hero_section > img').setAttribute('data-src','//res.cloudinary.com/ignite-visibility/image/upload/f_auto/CyberGRX/Add_Demo_Form_Homepage/Homepage-CTA-BG2.jpg');
        document.querySelector('.hero_section > img').setAttribute('src','//res.cloudinary.com/ignite-visibility/image/upload/f_auto/CyberGRX/Add_Demo_Form_Homepage/Homepage-CTA-BG2.jpg');
