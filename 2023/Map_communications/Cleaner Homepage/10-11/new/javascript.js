function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('form_iv')) {
        ...
        var formWrap = document.querySelector('.form_iv .contact-form .wrap, .form_iv .start-trial-section .wrap');
        ...
        var touchFormWrap = document.querySelector('.form_iv .contact-form .wrap .touch-form-wrap, .form_iv .start-trial-section .touch-form-wrap');
