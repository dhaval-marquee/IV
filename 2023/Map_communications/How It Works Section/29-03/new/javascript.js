    ...
    if (!$('body').hasClass('homepage_test')) {
        ...
        $('.homepage_test.home .top-section .wrap h2').after(`<section class="slider_section">
            <ul class="slider_wrapper">
                <li>
                <div>
                    <img src="//res.cloudinary.com/ignite-visibility/image/upload/f_auto/mapcommunications/%2AHomepage%20Redesign/Delta-gs_2x.jpg" alt="Delta gs">
                    </div>
                </li>
                <li>
                <div>
                    <img src="//res.cloudinary.com/ignite-visibility/image/upload/f_auto/mapcommunications/%2AHomepage%20Redesign/HoltCat-gs_2x.jpg" alt="HoltCat-gs">
                    </div>
                </li>
                <li>
                <div>
                    <img src="//res.cloudinary.com/ignite-visibility/image/upload/f_auto/mapcommunications/%2AHomepage%20Redesign/Humana-gs_2x.jpg" alt="Humana-gs">
                    </div>
                </li>
                <li>
                <div>
                    <img src="//res.cloudinary.com/ignite-visibility/image/upload/f_auto/mapcommunications/%2AHomepage%20Redesign/International-Paper-gs_2x.jpg" alt="International-Paper-gs">
                    </div>
                </li>
                <li>
                <div>
                    <img src="//res.cloudinary.com/ignite-visibility/image/upload/f_auto/mapcommunications/%2AHomepage%20Redesign/MSinaiLogo-gs_2x.jpg" alt="MSinaiLogo-gs">
                    </div>
                </li>
                <li>
                <div>
                    <img src="//res.cloudinary.com/ignite-visibility/image/upload/f_auto/mapcommunications/%2AHomepage%20Redesign/ServPro-gs_2x.jpg" alt="ServPro-gs">
                    </div>
                </li>
            </ul>
        </section>`);
        ...
        <div class="live-call-section cf integrations_section">
            <div class="live-call-section cf integrations_inner">
                <div class="elementor-row integrations_top">
                    <div class="integrations_h2-wrap">
                        <h2>Seamlessly Integrate With the Tools and Platforms Your Business Already Uses</h2>
                    </div>
                    <div class="integrations_item">
                        <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1668144991/mapcommunications/%2AHomepage%20Redesign/Zapier.png" alt="Zapier">
                        <p>Map Communications has developed a relationship with Zapier that allows us to provide integrations with over 3,000 apps</p>
                    </div>
                </div>
                <div class="m-all t-all d-1of3 live-call-box">
                    <div class="live-call-box_inner">
                        <div>
                            <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1668144994/mapcommunications/%2AHomepage%20Redesign/Calendly.png" alt="Calendly">
                        </div>
                ...
                <div class="m-all t-all d-1of3 live-call-box">
                    <div class="live-call-box_inner">
                        <div>
                            <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1668144999/mapcommunications/%2AHomepage%20Redesign/Acuity.png" alt="Acuity">
                        </div>
                ...
                <div class="m-all t-all d-1of3 live-call-box">
                    <div class="live-call-box_inner">
                        <div>
                            <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1668144991/mapcommunications/%2AHomepage%20Redesign/Google_Calendar.png" alt="Google Calendar">
                        </div>
                ...
                <div class="m-all t-all d-1of3 live-call-box item">
                    <div class="live-call-box_inner">
                        <div>
                            <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1668144992/mapcommunications/%2AHomepage%20Redesign/Setmore.png" alt="Setmore">
                        </div>
                ...
                <div class="m-all t-all d-1of3 live-call-box item">
                    <div class="live-call-box_inner">
                        <div>
                            <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1668144991/mapcommunications/%2AHomepage%20Redesign/Rocket_Matter.png" alt="Rocket Matter">
                        </div>
                        <p>We'll help you manage all your leads and client details in one place with Rocket Matter's legal case management platform.</p>
                    </div>
                </div>
                <div class="m-all t-all d-1of3 live-call-box item">
                    <div class="live-call-box_inner">
                        <div>
                            <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1668144994/mapcommunications/%2AHomepage%20Redesign/Clio.png" alt="Clio">
                        </div>
                        <p>Whether you use Clio Grow or Clio Manage, we'll seamlessly Integrate so you can manage your law firm efficiently.</p>
                    </div>
                </div>
                <div class="m-all t-all d-1of3 live-call-box item">
                    <div class="live-call-box_inner">
                        <div>
                            <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1668144993/mapcommunications/%2AHomepage%20Redesign/Zoho.png" alt="Zoho">
                        </div>
                ...
                <div class="m-all t-all d-1of3 live-call-box item">
                    <div class="live-call-box_inner">
                        <div>
                            <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1668144991/mapcommunications/%2AHomepage%20Redesign/Hubspot.png" alt="Hubspot">
                        </div>
                ...
                <div class="m-all t-all d-1of3 live-call-box item">
                    <div class="live-call-box_inner">
                        <div>
                            <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1668144991/mapcommunications/%2AHomepage%20Redesign/Salesforce.png" alt="Salesforce">
                        </div>
            ...
            <div class="wrap">
                ...
                <div class="how_work_wrapper flex-boxes">
                    <div class="how_work_content flex-box">
                        ...
                        <p>Tell us about your business and our talented virtual receptionists will have your calls covered in no time. We'll craft a customized script to match your preferred language, policies, and procedures.
                        </p>
                    </div>
                    <div class="how_work_content flex-box">
