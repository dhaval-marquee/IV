function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('pricingPage')) {
        bodyEle.classList.add('pricingPage');
        
        // Put your test code here
        var formWrapper = document.querySelector('.pricingPage .contact-form, .pricingPage .start-trial-section');
