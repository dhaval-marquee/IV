function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('amPerksPageTest')) {
        ...
        <div class="amPerksJoinng">
            <h2>Joining AmPerks Is Easy and Free!</h2>
            <ul>
                <li>
                    <div class="imgWrapper">
                ...
                <li>
                    <div class="imgWrapper">
                        <img class="boximg" src="//res.cloudinary.com/ignite-visibility/image/upload/f_auto/amway/BoxImg.png" alt="Fill out the quick 3-step customer registration form.">
                    </div>
        ...
        document.querySelector('.amPerksJoinng ~ .js-rich-text-alert-container').insertAdjacentHTML('beforebegin' , `<div class="redeemRewardSection">
            <div class="content">
    ...
    document.querySelectorAll('.amw-content-component--extended .amw-content-component__title-wrapper +.amw-content-component__tiles-container .amw-button').forEach(function(button) {
        button.innerHTML = button.innerHTML.replace('Create Customer Account', 'Join AmPerks!');
      });
      
      document.querySelectorAll('.amw-content-component--extended .amw-content-component__title-wrapper +.amw-content-component__tiles-container .amw-content-component__tile-actions  div+div').forEach(function(div) {
