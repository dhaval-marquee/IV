...
var jQisLoaded = setInterval(function () {
    if (typeof jQuery != 'undefined') {
        ...
        if (!$('body').hasClass('iv_healthcare')) {
            ...
            $(".iv_healthcare #smart-hero .smart-hero-inner .carousel-item:first-child h1").text("Comprehensive Healthcare Revenue Cycle Management");
            $(".iv_healthcare #smart-hero .smart-hero-inner .carousel-item:first-child p").text("Experian Health’s data-driven insights give you the power to streamline operations, increase revenue, and improve patient experience - simplifying healthcare for all");
        }
