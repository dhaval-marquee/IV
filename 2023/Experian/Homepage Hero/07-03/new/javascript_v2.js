...
var jQisLoaded = setInterval(function () {
    if (typeof jQuery != 'undefined') {
        ...
        if (!$('body').hasClass('iv_healthcare')) {
            ...
            $(".iv_healthcare #smart-hero .smart-hero-inner .carousel-item:first-child h1").text("Simplifying Healthcare For All");
            $(".iv_healthcare #smart-hero .smart-hero-inner .carousel-item:first-child p").text("For over 25 years Experian Health has worked closely with over 500,000 providers, helping them make smarter business decisions and improve patient experiences");
        };
