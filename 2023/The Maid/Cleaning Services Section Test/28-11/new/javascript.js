function loadTestCode() {
    if (!$('body').hasClass('popup_iv')) {
        ...
        document.querySelector('#services-section .container').insertAdjacentHTML('afterend',`<div class="container section_title">
            <p class="first-title">Cleaning Services We Offer</p>
            <span style="color:var(--grey);font-size:12px;">*services offered vary by location</span>
            <div class="fancy_divider"></div>
        </div>
        <div class="popupItems"></div><div class="popupItemPopup"></div>`);
