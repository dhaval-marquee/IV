		...
		var getLength = setInterval(() => {
			if(document.querySelectorAll('div[class*="paypalSection"]').length && document.querySelectorAll('div[class*="ExpressCheckout_expressCheckout"]').length) {
				...
				const jsonData = {
					'/product/22752-tigon' : {
						product1 : {
							img: "//res.cloudinary.com/ignite-visibility/image/upload/f_auto/shoesforcrews/Adding_Features_to_PDP/Slip-Resistant.png",
							title: 'Slip-Resistant',
							alt: "Slip Resistant"
						},
						product2 : {
							img: "//res.cloudinary.com/ignite-visibility/image/upload/f_auto/shoesforcrews/Adding_Features_to_PDP/TRIPGUARD.png",
							title: 'Trip Guard',
							alt: "Trip Guard"
						},
						product3 : {
							img: "//res.cloudinary.com/ignite-visibility/image/upload/f_auto/shoesforcrews/Adding_Features_to_PDP/Water_Resistant.png",
							title: 'Water Resistant',
							alt: "Water Resistant"
						},
						product4 : {
							img: "//res.cloudinary.com/ignite-visibility/image/upload/f_auto/shoesforcrews/Adding_Features_to_PDP/Extra_Cushion.jpg",
							title: 'Extra Cushion',
							alt: "Extra Cushion"
						}
					},
					...
					'/product/22002-new-balance-arishi-v3' : {
						...
						product3 : {
							img: "//res.cloudinary.com/ignite-visibility/image/upload/f_auto/shoesforcrews/Adding_Features_to_PDP/EasyClean.png",
							title: 'Easy Clean',
							alt: "Easy Clean"
						},
						product4 : {
							img: "//res.cloudinary.com/ignite-visibility/image/upload/f_auto/shoesforcrews/Adding_Features_to_PDP/Breathable.jpg",
							title: 'Breathable',
							alt: "Breathable"
						}
					},
					...
					'/product/22201-gia' : {
						...
						product4 : {
							img: "//res.cloudinary.com/ignite-visibility/image/upload/f_auto/shoesforcrews/Adding_Features_to_PDP/Revive.png",
							title: 'Revive',
							alt: "Revive"
						}
					},
					...
					'/product/77632-dewalt-plasma-steel-toe' : {
						...
						product2 : {
							img: "//res.cloudinary.com/ignite-visibility/image/upload/f_auto/shoesforcrews/Adding_Features_to_PDP/Electrical_Hazzard.png",
						...
						product4 : {
							img: "//res.cloudinary.com/ignite-visibility/image/upload/f_auto/shoesforcrews/Adding_Features_to_PDP/Safety_Toe.png",
							title: 'Safety Toe',
							alt: "Safety Toe"
						}
					},
					'/product/77282-redrock-composite-toe' : {
						...
						product3 : {
							img: "//res.cloudinary.com/ignite-visibility/image/upload/f_auto/shoesforcrews/Adding_Features_to_PDP/Galdiator.png",
							title: 'Galdiator',
							alt: "Galdiator"
						},
						product4 : {
