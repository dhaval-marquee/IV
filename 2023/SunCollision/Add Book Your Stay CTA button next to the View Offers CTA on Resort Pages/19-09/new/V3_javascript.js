    ...
    if (!bodyEle.classList.contains('resort_iv')) {
        ...
        var ctaInterval = setInterval(function() {
            ...
            if (ctaElements.length > 0) {
                ...
                var firstcta = document.querySelectorAll('.resort_iv .intro .cta.orange-solid');
                firstcta.forEach(function(cta) {
                    cta.classList.remove('orange-solid');
                    cta.classList.add('orange-outline');
                });
            }
        }, 100);
    }
