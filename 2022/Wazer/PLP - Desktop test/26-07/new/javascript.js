function desktopCode() {
	if(!$('body').hasClass('iv_wazer_lp')) {
		...
		// Key Features
		var urlStart = '//res.cloudinary.com/ignite-visibility/image/upload/wazer/waterjet/';
		var featureLists = [
			{
				icon: 'Cutting-Area',
			...
			{
				icon: 'support-icon',
				text: '<strong>World class support</strong> connects you directly to one of our experts to solve your problems quickly.'
			}
		];
		var featureHtml = '';
		...
		var demoBtn = '<a class="orange-btn" href="https://shop.wazer.com/pages/waterjet-request-a-live-1on1-demo">Get a Live Demo</a>';
		...
		<div class="features-section"><div class="container"><h3>Key Features</h3>'+featureHtml+'</div></div>\
		<div class="technical-section"><div class="container"><h3>Technical Specs</h3><div class="shogun-accordion-wrapper">'+accordionHtml+'</div></div>\</div>\
		<div class="faq-section"><div class="container"><h3>FAQ</h3><div class="faq-wrapper">'+faqHtml+'</div></div></div>');
