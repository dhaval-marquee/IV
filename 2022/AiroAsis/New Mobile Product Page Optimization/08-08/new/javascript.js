function loadcode() {
    if (!$('body').hasClass('iv_mobile')) {
        ...
        // $('.main-product__product-description').before($('.main-product__html'));
        ...
        $('.main-product__product-description').before(`<ul class="return_policies">
            <li>
                <span class="img_wrapper">
                    <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1659943695/Air_Oasis/Free_Shipping.png" alt="Shipping Truck Icon" width='50' >
                </span>
                <span>Free Shipping</span>
            </li>
            <li>
                <span class="img_wrapper">
                    <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1659943694/Air_Oasis/Easy_Returns.png" alt="Return Item Image" width='33' >
                </span>
                <span>Easy 60-Day Returns</span>
            </li>
            <li>
                <span class="img_wrapper">
                    <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1659943695/Air_Oasis/Lifetime_Warranty.png" alt="Warranty badge" width='30' >
                </span>
