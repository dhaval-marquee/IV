...
if(currentPageURL == 'https://www.airoasis.com/blogs/articles/what-happens-when-you-inhale-black-mold-spores') {
    if(document.querySelectorAll('.blog_page_text_links').length == 0) {
        ...
        newItem.innerHTML = '<a href="https://www.airoasis.com/pages/shop-by-concern-mold">iAdapt Air eliminates 99% of mold spores without harsh chemicals</a>';
    ...
    if(document.querySelectorAll('.blog_page_text_links').length == 0) {
        ...
        var newItem = document.createElement('div');
        newItem.className = "blog_page_text_links";
        newItem.innerHTML = '<a href="https://www.airoasis.com/pages/shop-by-concern-mold">Eliminate 99% of mold spores without harsh chemicals with the iAdapt Air</a>';
        addBeforeThis.parentNode.insertBefore(newItem,addBeforeThis);
    }
    ...
    if(document.querySelectorAll('.blog_page_text_links').length == 0) {
        ...
        var newItem = document.createElement('div');
        newItem.className = "blog_page_text_links";
        newItem.innerHTML = '<a href="https://www.airoasis.com/pages/shop-by-concern-mold">iAdapt Air eliminate 99% of mold spores quickly, allowing you to breathe easier</a>';
        addBeforeThis.parentNode.insertBefore(newItem,addBeforeThis);
    }
}