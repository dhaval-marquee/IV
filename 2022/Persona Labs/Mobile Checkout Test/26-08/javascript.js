...
function IVTestCode() {
    if (!jQuery('body').hasClass('test_iv')) {
        ...
        jQuery('.test_iv .woocommerce-additional-fields').parent().removeAttr('style');
        ...
        jQuery('#order_review_heading').before('<div id="newslatter_wrapper"></div>');
        jQuery('#newslatter_wrapper').append(jQuery('#payment .constant-contact-app-optin').clone());
        jQuery('#newslatter_wrapper').append(jQuery('#payment .rxspark-app-optin').clone());


        jQuery('#newslatter_wrapper input[name="constant_contact_optin"]').change(function(){
            if(this.checked) {
                console.log('true');
                jQuery('#payment input[name="constant_contact_optin"]').prop('checked',true);
            } else {
                console.log('false');
                jQuery('#payment input[name="constant_contact_optin"]').prop('checked',false);
            }
        });

        jQuery('#newslatter_wrapper input[name="rxspark_app_status"]').change(function(){
            if(this.checked) {
                console.log('true');
                jQuery('#payment input[name="rxspark_app_status"]').prop('checked',true);
            } else {
                console.log('false');
                jQuery('#payment input[name="rxspark_app_status"]').prop('checked',false);
            }
        });
