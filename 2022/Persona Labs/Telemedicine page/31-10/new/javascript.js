function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('telemedicine_test')) {
        ...
        jQuery('.telemedicine_test .subtitle-text p').html('Our board-certified network of doctors can provide you with medical advice and fill prescriptions through virtual doctor visits - no insurance required');
        ...
        jQuery('.telemedicine_test .elementor-element.elementor-element-993c22f > .elementor-widget-container div').html('Our board-certified network of doctors can provide you with medical advice and fill prescriptions through virtual doctor visits - no insurance required');
                ...
                <div class="elementor-row">
                    ...
                    <div class="elementor-column elementor-col-25 elementor-inner-column elementor-element elementor-element-5d519722" data-id="5d519722" data-element_type="column">
                        ...
                        <img alt="Cell phone" class="panel-main-image" src="//res.cloudinary.com/ignite-visibility/image/upload/v1667210753/Persona_Labs/Telemedicine_page/doctor_icon_2x.svg">
                            <span class="works_span"> 
                              <span class="list-bold">Choose Your Doctor</span>Select from hundreds of doctors around the nation
                            </span>
                        </div>
                    </div>
    ...
    <div class="offer_inner">
        ...
        <div class="offer_item">
            <p>Consult with one of our doctors for treatment and prescription medication for these conditions and
                more:</p>
