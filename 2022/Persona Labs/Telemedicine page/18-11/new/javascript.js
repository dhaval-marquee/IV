function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('telemedicine_test')) {
        ...
        jQuery('.elementor-inner > .elementor-section-wrap').eq(1).find('section').eq(0).addClass('hero_section');
        jQuery('.hero_section h2').html('<h1>Personalized, High-Quality, & Affordable Health Care From the Comfort of Your Home</h1>');

        jQuery(".hero_section .elementor-column.elementor-col-50").each(function (index) {
            jQuery(this).addClass("section" + index);
        });

        jQuery('.section0 .elementor-element:nth-child(2),.section1 .elementor-element:nth-child(2)').html('<p>Our board-certified network of doctors can provide you with medical advice and provide the appropriate treatment through virtual doctor visits - no insurance required</p>');
        ...
        jQuery('.section0 .elementor-element:nth-child(3) a span.elementor-button-text,.section1 .elementor-element:nth-child(3) a span.elementor-button-text').html('Get Started');
        ...
        <section class="offer_section">
            <div class="offer_inner">
                ...
                <div class="offer_item">
                    <p>Consult with one of our doctors for treatment, test results, and prescription medication for these conditions and more:</p>
                ...
                <div class="btn_wrap">
                    <a href="/my-account/telemedicine/#my-account-section" class="elementor-button-link elementor-button elementor-size-sm" role="button">
