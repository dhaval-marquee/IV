function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('verification_test')) {
        ...
        $('.verification_test .info-module').before($('body.verification_test #phone-validate-demo-container'));
            ...
            <div class="container">
                <ul>
                    <li>
                        ...
                        <p>62 M+ PHONE NUMBER VALIDATION REQUESTS EACH YEAR</p>
                    </li>
                    <li>
                        ...
                        <p>99% GUARANTEED SERVICE UPTIME</p>
                    </li>
                    <li>
                        ...
                        <p>240 COUNTRIES AND TERRITORIES COVERED</p>
                    </li>
                </ul>
            </div>
        </section>`);
