function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('home_iv')) {
        ...
        $('.home_iv #our-mission').closest('.cmp-container').after(`<div class="faq_wrapper">
            <h3>FAQs</h3>
            <div class="faq-wrap">
                <label>Who develops asthma?
                    <span class="fa fa-minus"></span>
                </label>
                <div class="content active">
                    <p>Allergies can happen at any age.</p>
                </div>
            </div>
            <div class="faq-wrap">
                <label>Is it possible to outgrown an allergy? <span class="fa fa-plus"></span></label>
                <div class="content">
                    <p>Beacuse allergies change over time, many people may outgrow old allergies and develop new ones.Some children stop reacting to allergens, such as milk and eggs, as the grow, yet allergies to foods such as nuts and fish tend to remain.</p>
                </div>
            </div>
            <div class="faq-wrap">
                <label>What don\`t allergy symptoms appear all the time? <span class="fa fa-plus"></span></label>
                <div class="content">
            ...
            <div class="faq-wrap">
                ...
                <div class="content">
                    <p>Allergic asthma, or allergy-induced asthma, is a type of asthma that is triggered or made worse by allergies.</p>
                </div>
            </div>
        </div>`);
