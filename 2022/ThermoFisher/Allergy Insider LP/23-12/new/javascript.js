function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('home_iv')) {
        ...
        $('.aem-Grid>.aem-GridColumn.aem-GridColumn--default--hide+div h1').after(`<p>We offer educational information about allergy conditions to help you make more empowered  health decisions. All of our content is:</p>
            <ul class="information">
                <li>Evidenced based</li>
                <li>Fact checked</li>
                <li>Approved by our medical and scientific affairs team</li>
            </ul>`);

            $('.cmp-button-card:nth-child(2)').before('<h3 class="weHelp">How Can We Help?</h3>');
            $('.cmp-button-card:nth-child(5)+div .cmp-text p:first-child').before(`<p>Allergy Insider is your trusted source to help you better understand your allergies. Here's how we do it:</p>
                <ul class="ourMission">
                    <li> 1) We rely on medical and scientific journals to support all the information we share, meaning everything is researched and referenced</li>
                    <li> 2) Our medical and scientific affairs team approves all of our content, an expert team of practicing healthcare professionals</li>
                    <li> 3) We break down complex topics into easy-to-digest nuggets of information</li>
                    <li> 4) We partner with medical professionals and various allergy-focused organizations to support our community as a trusted resource for you</li>
                </ul>`);
