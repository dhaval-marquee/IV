function initCode() {
    jQuery(document).ready(function(jQuery){
        if(!jQuery('body').hasClass('mobile_redesign_test')) {
            ...
            jQuery('.mob-2').addClass('asap-service-redesign')
            jQuery(".mob-3 .mcb-wrap-inner .column").each(function (index) {
            ...
            jQuery(".asap-service-redesign .section_wrapper .section-0 .mcb-wrap-inner .column").each(function (index) {
             ...
             jQuery(".mob-3 .mcb-section-inner .wrap").each(function (index) {
            ...
            //iV_drip
            jQuery('.mob-3').after('<div class="iV_drip">\
