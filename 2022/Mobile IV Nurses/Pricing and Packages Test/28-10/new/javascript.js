function SPZTestCode() {
    if (!jQuery('body').hasClass('pricing_packages')) {
        ...
        jQuery('.product_wrapper .product_iv .button').each(function(){
            jQuery(this).closest('.product_content').after(jQuery(this));
        });
        ...
        jQuery('.product_wrapper .product_iv a.button').each(function(){
            jQuery(this).find('.button_label').text('Book Now');
        });
        ...
        jQuery('.product_content .content_right').nextAll().remove();
                ...
                <ul>
                    <li>
                        <div class="img_wrapper">
                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1661152362/mobileIVnurses/Pricing_and_Packages_Test/Fast.png" alt="Clock icon">
                        </div>
                        <h3>Fast</h3>
                    ...
                    <li>
                        <div class="img_wrapper">
                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1661152362/mobileIVnurses/Pricing_and_Packages_Test/Affordable.png" alt="Money saving icon">
                        </div>
                        <h3>Affordable</h3>
                    ...
                    <li>
                        <div class="img_wrapper">
                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1661152362/mobileIVnurses/Pricing_and_Packages_Test/Effective.png" alt="checkmark with rounded">
                        </div>
                        <h3>Effective</h3>
                    ...
                    <li>
                        <div class="img_wrapper">
                            <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1661152362/mobileIVnurses/Pricing_and_Packages_Test/Convenient.png" alt="user friendly">
                        </div>
                        <h3>Convenient</h3>
        ...
        jQuery('.product_wrapper .product_iv .product_content .content_right').after('<a href="javascript:;" class="learn_more_link">Learn More</a>');
