...
function mobilecode() {
    jQuery(document).ready(function(jQuery){
        if(!jQuery('body').hasClass('mobile_redesign_test')) {
            ...
            jQuery('.mobile_redesign_test .sections_group .section.mcb-section.mcb-section-hf3po8unt').after('<div class="iV_Nurses">\
            ...
            jQuery('.mobile_redesign_test .iV_Nurses').after('<div class="iV_drip">\
                ...
                <div class="mcb-wrap-inner">\
                    <div class="iV_drip_wrap">\
                        <div class="iV_drip_inner">\
                            <div class="image">\
                                <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1657957592/mobileIVnurses/home-page/HomePage_redesign/Myers_Bag.jpg"  alt="Myers_Bag">\
                            </div>\
                            <div class="desc">\
                                <h3 class="headline">Myers\' Cocktail - jQuery195</h3>\
                    ...
                    <div class="iV_drip_wrap">\
                        <div class="iV_drip_inner">\
                            <div class="image">\
                                <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1657957592/mobileIVnurses/home-page/HomePage_redesign/Ultimate_Myers_Bag.jpg" alt="Myers_Bag">\
                            </div>\
                            <div class="desc">\
                                <h3 class="headline">Ultimate Myers - jQuery295</h3>\
                    ...
                    <div class="iV_drip_wrap">\
                        <div class="iV_drip_inner">\
                            <div class="image">\
                                <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1657957592/mobileIVnurses/home-page/HomePage_redesign/Performance_Plus_Bag.jpg" alt="Myers_Bag">\
                            </div>\
                            <div class="desc">\
                                <h3 class="headline">The Performance Plus - jQuery325</h3>\
                                <p class="sub_Head">Our Best Selling Package</p>\
                                <ul>\
            ...
            jQuery('.mobile_redesign_test .iV_drip').after('<div class="benefits_IV">\
            <div class="section_wrapper">\
              <h2 class="title">Benefits of IV Drips</h2>\
              <ul>\
                  <li>\
                      <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1657957592/mobileIVnurses/home-page/HomePage_redesign/Myers_Bag.jpg" alt="Myers Bag icon">\
                      <h4>Fast</h4>\
                      <p style="font-size:16px">IV\'s are highly efficient with an immediate effect</p>\
                  </li>\
                  <li>\
                      <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1657957592/mobileIVnurses/home-page/HomePage_redesign/Myers_Bag.jpg" alt="Myers Bag icon">\
                      <h4>Affordable</h4>\
                      <p style="font-size:16px">Mobile IV services cost less than a hospital service</p>\
                  </li>\
                  <li>\
                      <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1657957592/mobileIVnurses/home-page/HomePage_redesign/Myers_Bag.jpg" alt="Myers Bag icon">\
                      <h4>Effective</h4>\
                      <p style="font-size:16px">IV treatments deliver nutrients right where they can do the most good</p>\
                  </li>\
                  <li>\
                      <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1657957592/mobileIVnurses/home-page/HomePage_redesign/Myers_Bag.jpg" alt="Myers Bag icon">\
                      <h4> Convenient</h4>\
                      <p style="font-size:16px">Save time and money by avoiding the hospital waiting room</p>\
                  </li>\
              </ul>\
            </div>\
            </div>');
            jQuery('.mobile_redesign_test #Content .benefits_IV').after('<div class="section the_content has_content">\
            <div class="section_wrapper">\
                <div class="the_content_wrapper ">\
                   <h3 style="margin-bottom:20px;display:block;width:100%;margin-top:10px">FAQs</h3>\
                    <div class="wpsm_panel-group" id="wpsm_accordion_4874">\
                        <!-- Inner panel Start -->\
                        <div class="wpsm_panel wpsm_panel-default">\
                            <div class="wpsm_panel-heading" role="tab">\
                                <h4 class="wpsm_panel-title">\
                                    <a class="collapsed" data-toggle="collapse" data-parent="" href="javascript:void(0)"\
                                        data-target="#ac_4874_collapse1" aria-expanded="false">\
                                        <span class="ac_open_cl_icon fa fa-plus"></span>\
                                        <span class="ac_title_class">What are your hours? </span>\
                                    </a>\
                                </h4>\
                            </div>\
                            <div id="ac_4874_collapse1" class="wpsm_panel-collapse collapse" aria-expanded="false"\
                                style="height: 0px;">\
                                <div class="wpsm_panel-body">\
                                    Our team provides mobile IV vitamin therapy from 8 a.m. to 8 p.m. daily. We also offer\
                                    24-hour service, depending on nurse availability.&nbsp; </div>\
                            </div>\
                        </div>\
                        <!-- Inner panel End -->\
                        <!-- Inner panel Start -->\
                        ...
                        <div class="wpsm_panel wpsm_panel-default">\
                            <div class="wpsm_panel-heading" role="tab">\
                                <h4 class="wpsm_panel-title">\
                                    <a class="collapsed" data-toggle="collapse" data-parent="" href="javascript:void(0)"\
                                        data-target="#ac_4874_collapse3">\
                                        <span class="ac_open_cl_icon fa fa-plus"></span>\
                                        <span class="ac_title_class">\
                                            How long does an IV treatment take?&nbsp; </span>\
                                    </a>\
                                </h4>\
                            </div>\
                            <div id="ac_4874_collapse3" class="wpsm_panel-collapse collapse ">\
                                <div class="wpsm_panel-body">\
                                    We specialize in&nbsp;prompt, responsive IV therapy. A typical appointment takes 30 to 45\
                                    minutes. The specific length of time for your IV infusion depends on the treatment you\
                                    select. </div>\
                            </div>\
                        </div>\
                        <!-- Inner panel End -->\
                        ...
                        <div class="wpsm_panel wpsm_panel-default">\
                            <div class="wpsm_panel-heading" role="tab">\
                                <h4 class="wpsm_panel-title">\
                                    <a class="collapsed" data-toggle="collapse" data-parent="" href="javascript:void(0)"\
                                        data-target="#ac_4874_collapse4">\
                                        <span class="ac_open_cl_icon fa fa-plus"></span>\
                                        <span class="ac_title_class">\
                                            Does insurance cover IV vitamin therapy? </span>\
                                    </a>\
                                </h4>\
                            </div>\
                            <div id="ac_4874_collapse4" class="wpsm_panel-collapse collapse ">\
                                <div class="wpsm_panel-body">\
                                    We do not accept insurance for treatment. However, we do take cash, check, debit, credit,\
                                    HSA, and FSA. Learn more about our&nbsp;payment policies and options. </div>\
                            </div>\
                        </div>\
                        <!-- Inner panel End -->\
                        <!-- Inner panel Start -->\
                        <div class="wpsm_panel wpsm_panel-default">\
                            ...
                            <div id="ac_4874_collapse8" class="wpsm_panel-collapse collapse ">\
                                <div class="wpsm_panel-body">\
                                    Just about anyone! Depending on their health history, IV therapy works well for people ages\
                                    10 and older who weigh more than 100 pounds. The patient must be able to consent to\
                                    treatment.&nbsp; </div>\
                            </div>\
                        </div>\
                        <!-- Inner panel End -->\
                        ...
                        <div class="wpsm_panel wpsm_panel-default">\
                            <div class="wpsm_panel-heading" role="tab">\
                                <h4 class="wpsm_panel-title">\
                                    <a class="collapsed" data-toggle="collapse" data-parent="" href="javascript:void(0)"\
                                        data-target="#ac_4874_collapse9">\
                                        <span class="ac_open_cl_icon fa fa-plus"></span>\
                                        <span class="ac_title_class">\
                                            How often should I get an IV treatment? </span>\
                                    </a>\
                                </h4>\
                            </div>\
                    ...
                    <div class="desc">\
                       <h3>Payment Methods</h3> We accept cash and all major credit cards. Our services are also HSA ( Health Savings Account) approved!\
                           <img style="max-width:90%" src="/wp-content/uploads/2021/07/accepted-cards.png" alt="all major cards accepted">\
                     </div>\
                </div>\
            </div>\
            </div>');
