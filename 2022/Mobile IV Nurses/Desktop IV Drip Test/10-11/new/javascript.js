function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('drip_test')) {
        ...
        jQuery('.drip_test_wrapper').each(function () {
                    ...
                    <div class="column mcb-column mcb-item-z2ld6f0c9 one column_pricing_item">
                        <div class="pricing-box  pricing-box-box">
                            <div class="plan-header">
                                <div class="image">
                                    <a href="https://mobileivnurses.com/pricing-packages/">
            ...
            <!-- 2nd product -->
            <div class="wrap mcb-wrap mcb-wrap-g0brex0y4 valign-top clearfix one-fourth pricing-box-featured" data-col="one-fourth">
                <div class="mcb-wrap-inner">
                    <div class="column mcb-column mcb-item-z2ld6f0c9 one column_pricing_item">
                        <div class="pricing-box  pricing-box-box">
                            <div class="plan-header">
