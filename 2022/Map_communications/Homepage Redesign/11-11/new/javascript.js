...
function loadCode() {
  if (!$('body').hasClass('homepage_test')) {
    ...
    <ul class="slider_wrapper">
        ...
        <li>
          <div>
              <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1668166681/mapcommunications/%2AHomepage%20Redesign/MAP_COMMUNICATIO_2x.png" alt="MAP COMMUNICATIO">
            </div>
        </li>
        <li>
          <div>
    ...
    <div class="live-call-section cf integrations_inner">
      ...
      <p class="integrations_text item">Not seeing your preferred integration? Tell us what you are looking for and we can create a custom solution for your business. </p>
      <a href="#" class="button integrations_btn block-btn">SEE ALL INTEGRATIONS</a>
  </div>
