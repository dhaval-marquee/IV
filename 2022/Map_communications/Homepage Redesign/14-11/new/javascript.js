...
function loadCode() {
  if (!$('body').hasClass('homepage_test')) {
    ...
    <div class="live-call-section cf integrations_inner">
      ...
      <p class="integrations_text item">Not seeing your preferred integration? Tell us what you are looking for and we can create a custom solution for your&nbsp&nbspbusiness. </p>
