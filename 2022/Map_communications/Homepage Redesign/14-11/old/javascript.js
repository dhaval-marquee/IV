  ...
  if (!$('body').hasClass('homepage_test')) {
    ...
    $('.homepage_test.home .top-section .wrap h2').after(`<section class="slider_section">
      <ul class="slider_wrapper">
          ...
          <li>
            <div>
                <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1668240288/mapcommunications/%2AHomepage%20Redesign/MAP_COMMUNICATIO.png" alt="MAP COMMUNICATIO">
              </div>
          </li>
          <li>
            <div>
          ...
          <li>
            <div>
                <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1668167231/mapcommunications/%2AHomepage%20Redesign/EchoLogo.png" alt="EchoLogo">
              </div>
          </li>
      </ul>
    </section>`);
    ...
    <div class="live-call-section cf integrations_inner">
      <div class="elementor-row integrations_top">
        <div class="elementor-column elementor-col-65 elementor-inner-column elementor-element elementor-element-7a13941f">
          <div class="integrations_item">
            <h2>Seamlessly Integrate With the Tools and Platforms Your Business Already Uses</h2>
          </div>
        </div>
        <div class="elementor-column elementor-col-35 elementor-inner-column elementor-element elementor-element-2bf62370">
          <div class="integrations_item">
          <img src="//res.cloudinary.com/ignite-visibility/image/upload/v1668144991/mapcommunications/%2AHomepage%20Redesign/Zapier.png" alt="Zapier">
            <span class="integrations_span">Map Communications has developed a relationship with Zapier that allows us to provide integrations with over 3,000 apps</span>
          </div>
        </div>
      </div>
      ...
      <div class="m-all t-all d-1of3 live-call-box item">
        <div>
          ...
          <p>Map Communications  will schedule your appointments for you. Your calendar stays full, and you stay <br>&nbsp productive.</p>
      </div>
      <div class="m-all t-all d-1of3 live-call-box item">
        <div>
      ...
      <p class="integrations_text item">Not seeing your preferred integration? Tell us what you are looking for and we can create a custom solution for <br class="text">your business. </p>
      <a href="#javascript;" class="button integrations_btn block-btn">SEE ALL INTEGRATIONS</a>
  </div>
