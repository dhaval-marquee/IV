function loadCode() {
    if (!$('body').hasClass('homepage_test')) {
      ...
      <div class="live-call-section cf integrations_inner">
        <div class="elementor-row integrations_top">
          ...
          <div
            ...
            <div class="integrations_item">
              <img
                src="https://res.cloudinary.com/ignite-visibility/image/upload/v1667979952/mapcommunications/%2AHomepage%20Redesign/software_platform_2x.png"
                alt="">
              <span class="integrations_span">Map Communications has developed a relationship with Zapier that allows us to
                provide integrations with over 3,000 apps</span>
            </div>
          </div>
        </div>
        ...
        <div class="m-all t-all d-1of3 live-call-box item">
          ...
          <p>Well help you manage all your leads and client details in one place with Rocket Matter's legal case management
            platform.</p>
        </div>
        <div class="m-all t-all d-1of3 live-call-box item">
          <div>
          ...
          <p>Whether you use Clio Grow or Clio Manage, well seamlessly Integrate so you can manage your law firm
            efficiently.</p>
        </div>
        <div class="m-all t-all d-1of3 live-call-box item">
          <div>
        ...
        <div class="m-all t-all d-1of3 live-call-box item">
          ...
          <p>Map Communications will schedule your appointments for you. Your calendar stays full, and you stay productive.
          </p>
        </div>
        <div class="m-all t-all d-1of3 live-call-box item">
          <div>
      ...
      <p class="integrations_text item">Not seeing your preferred integration? Tell us what you are looking for and we can
        create a custom solution for your business. </p>
