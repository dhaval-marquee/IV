function initCode() {
    jQuery(document).ready(function(jQuery){
        if(!jQuery('body').hasClass('mobile_redesign_test')) {
            ...
            jQuery('.mobile_redesign_test header .container a.site-logo').html('<img src="//res.cloudinary.com/ignite-visibility/image/upload/v1661583248/BillHowe/BillHowe_logo/Bill_Howe_black_white.png" alt="BillHowe Logo">');
