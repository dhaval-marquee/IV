function initCode() {
    function loadcode() {
        if(!jQuery('body').hasClass('desktop_redesign_test')) {
            ...
            jQuery('.desktop_redesign_test header .container a.site-logo').html('<img src="//res.cloudinary.com/ignite-visibility/image/upload/v1661581166/BillHowe/BillHowe_logo/Bill_Howe_logo.png" alt="BillHowe Logo">');

            jQuery('header .container a.site-logo').prependTo(jQuery('header .the-navigation nav.util'));
            jQuery('.desktop_redesign_test section.hero').append('<div class="hero_img_wrapper"></div>');
