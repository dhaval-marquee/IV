function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('test_jazzercise')) {
       ...
       <div class="container">\          
        ...
        // $('#ls_solutions_video_2').hide().before(`
        //     <video width="100%" controls autoplay>
        //         <source src="https://res.cloudinary.com/ignite-visibility/video/upload/v1664873587/jazzercise/Homepage_Test/CRO_HomepageTest_Video_Homepageoriginalnooverlay_1920x1080.mp4" type="video/mp4">
        //         <source src="movie.ogg" type="video/ogg">
        //         Your browser does not support the video tag.
        // </video>`);

        // $('#ls_solutions_video_2').hide().before(`<div style="padding:56.25% 0 0 0;position:relative;">
        //     <iframe src="https://player.vimeo.com/video/593498481?h=44ccc3b78b&badge=0&autopause=0&player_id=0&app_id=58479" frameborder="0" allow="autoplay; fullscreen; picture-in-picture" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;" title="2021 WEB PAGE VIDEO FINAL.mp4"></iframe>
        //     </div>
