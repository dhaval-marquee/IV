function loadTestCode() {
  ...
  if (!bodyEle.classList.contains('test_jazzercise')) {
      ...
      $('.test_jazzercise .faq_section').before(`<div class="information">
          <div class="container ">
              ...
              <div class="inner-information reverse">
                  ...
                  <div class="img-box">
                      <div class="img-inn-box"><img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1668146720/jazzercise/Homepage_Test/OnDemand_v2_New.jpg" alt="On Demand"></div>
                  </div>
              </div>
              <div class="inner-information">
                  <div class="info-text">
                  ...
                  <div class="img-box">
                      <div class="img-inn-box"><img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1668149162/jazzercise/Homepage_Test/Livestream_Image_New.jpg" alt="Live Stream"></div>
                  </div>
              </div>
          </div>
      </div>`);
      ...
      function updateSearchBar(){
          ...
          var videoSectionHeight = $('#showImage').height();
          var sectionHeight = videoSectionHeight + 200
