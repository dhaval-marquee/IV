if (!$('body').hasClass('iv_jazzercise')) {
    ...
    $('.iv_jazzercise .vide-details-txt h1').text('THE PARTY STARTS HERE');
    $('.iv_jazzercise .vide-details-txt h2').html('<span class="mobile_hide">Get a fun + effective total-body workout that works for all ages and fitness levels. Certified Jazzercise instructors guide you through cardio and strength routines that leave you glowing from the inside out.</span><span class="mobile_show">Get a fun + effective total-body workout that works for all ages and fitness levels. Certified Jazzercise instructors guide you through cardio and strength routines that leave you glowing from the inside out.</span>');
    $('#content-wrapper .container').first().addClass('look_better_section');
    $('.look_better_section').next('#showVideo').removeAttr('style');
    ...
    $(window).on("resize", function () {
        ...
        if($(window).width() >= $(window).height()) {
            $('.look_better_section').next().css('height', 'calc(100vh - '+totalHeight+'px)');
        } else {
            $('.look_better_section').next().css('height', '920px');
        }
    }).resize();
    ...
    $('.look_better_section').next().after('<div class="container">\
	    <div class="our_class">\
	        ...
	        <div class="class_inner_content">\
	            ...
	            <div class="class_box">\
	                <h3><span>Flip Fusion</span></h3>\
	                <p>Shed calories and build muscle with this format that alternates targeted strength training for your arms, legs, and core with quick bursts of cardio for a truly toned physique.</p>\
	            </div>\
	            <div class="class_box">\
	                <h3><span>Fusion</span></h3>\
	                <p>Fire up your metabolism in this HIIT class that combines high- and low-intensity dance-based cardio and targeted strength work sprinkled throughout. Finish with concentrated strength training.</p>\
	            </div>\
	            <div class="class_box">\
	                <h3><span>LO</span></h3>\
	            ...
	            <div class="class_box collapse">\
	                <h3><span>Interval Dance Mixx</span></h3>\
	                <p>Promote longevity as you alternate between high- and low-intensity dance-based cardio intervals (HIIT). Finish with 20 minutes of strength training and stretching.</p>\
	            </div>\
	            <div class="class_box collapse">\
	                <h3><span>Interval Fusion</span></h3>\
	            ...
	            <div class="class_box collapse">\
	                <h3><span>Strength 35/45/60</span></h3>\
        ...
        <div class="container">\
            ...
            <div class="row">\
                <div class="col-md-4 col-sm-12">\
                    <h3><span>In Person</span></h3>\
                    <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1657778658/jazzercise/Jazzercise_Classes_Page/starthere_canitakeclassesineperson.jpg" alt="Classes Persons">\
                ...
                <div class="col-md-4 col-sm-12">\
                    <h3><span>On Demand</span></h3>\
                    <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1657778883/jazzercise/Jazzercise_Classes_Page/Women_with_child.jpg" alt="Women With Child">\
                ...
                <div class="col-md-4 col-sm-12">\
                    <h3><span>Livestream</span></h3>\
                    <img src="https://res.cloudinary.com/ignite-visibility/image/upload/v1657778658/jazzercise/Jazzercise_Classes_Page/job.jpg" alt="Job">\
	...
	$('#showClasses').on('click', function(){
		$('.class_inner_content .collapse').slideToggle(300);
	});
