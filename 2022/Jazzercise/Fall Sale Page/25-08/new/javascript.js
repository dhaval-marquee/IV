...
if (!$('body').hasClass('backonthebeat_hero_v1')) {
    ...
    $('h1.hero_subtitle span').text('See for yourself with free unlimited workouts through September!');
}
...
if (!$('body').hasClass('backonthebeat_hero_v2')) {
    ...
    $('h1.hero_subtitle span').text('Get back on the beat with free unlimited workouts through September and save up to $130!');
}