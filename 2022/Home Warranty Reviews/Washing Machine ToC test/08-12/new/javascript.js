function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('machine_ToC_test')) {
        ...
        $('.article_para0').after(`<div class="company_list_jumplink mb-4">
            <ul>
                <li>
        ...
        // Put your test code here
        $('#q1+p').addClass('bonusVideo').prev().before(`<div class="bonus_btn_wrap">
            <h2>The average homeowner spends $3000 a year on upkeep and repairs. Protect your investment starting at $27 a month.</h2>
            <a href="https://www.homewarrantyreviews.com/" class="CTA_btn visit_site bonusVideo_btn">Learn More</a>
        </div>`);
