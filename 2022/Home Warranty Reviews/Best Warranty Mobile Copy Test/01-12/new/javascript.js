function initCode() {
    jQuery(document).ready(function(jQuery){
        if(!jQuery('body').hasClass('mobile_redesign_test')) {
            ...
            $('.mobile_redesign_test p.title-0').replaceWith('<p class="sub-title">This is the list of <b> best home warranty companies for December 2022 </b> as reviewed by the editors of <b>HomeWarrantyReviews.com.</b></p>');
