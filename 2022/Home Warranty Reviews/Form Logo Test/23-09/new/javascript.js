function loadCode() {
    ...
    if (!$('body').hasClass('hero_redesign')) {
        ...
        // $('.hero_redesign .form_wrapper input[name="pe_btn_location"]').each(function(){
		// 	var getVal = $(this).attr('value');
		// 	$(this).attr('value',getVal+'_V1');	
		// });

        $('.hero_redesign .form_wrapper input[name="pe_priceestimate_type"]').attr('value','VARIANT_1');

        function next_slide() {
            var current_value = getValue('#current');
            var next_value = parseInt(current_value) + 1;
            removeClass("#review_section_" + current_value, "review_display")
            var next_slide = document.getElementById("review_section_" + next_value);
            addClass("#review_section_" + next_value, "review_display")
            current_value.value = next_value;
            setValue('#current', next_value);
            if (next_value == 5) {
                displayDivFormat("#right_arrow", "none");
                displayDivFormat("#left_arrow", "block");
            } else {
                displayDivFormat("#left_arrow", "block");
            }
        }
        ...
        function prev_slide() {
            ...
            setValue('#current', next_value);
            if (next_value == 1) {
                displayDivFormat("#left_arrow", "none")
                displayDivFormat("#right_arrow", "block");
            } else {
                displayDivFormat("#right_arrow", "block");
            }
        }
        ...
        $('.form_banner_right').removeAttr('class').addClass('col-lg-6 generic-popupleft-bnner').html(`
            ...
            <div class="mt-5 review_width" style="position: relative;">
                ...
                <div class="arrow-carousel">
                    ...
                    <div id="left_arrow" class="left-arrow" style="display: none;">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40">
                            <path d="m15.5 0.932-4.3 4.38 14.5 14.6-14.5 14.5 4.3 4.4 14.6-14.6 4.4-4.3-4.4-4.4-14.6-14.6z"></path>
                        </svg>
                    </div>
                    <div id="right_arrow" class="right-arrow" style="display: block;">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 40 40" width="40" height="40">
                            <path d="m15.5 0.932-4.3 4.38 14.5 14.6-14.5 14.5 4.3 4.4 14.6-14.6 4.4-4.3-4.4-4.4-14.6-14.6z"></path>
                        </svg>
                    </div>
