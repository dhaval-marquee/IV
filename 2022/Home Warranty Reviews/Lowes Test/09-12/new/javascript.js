function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('homewarrantyreviews_test')) {
		...
		document.querySelector('.company_info').insertAdjacentHTML(
		 ...
		 <div>
			<div class="horizontal_dotted_line"><span class="premium_content">Customer Reviews</span><span class="dot"></span><span class="premium_val" id="reviewNumber">439</span></div>
		...
		document.querySelector('#reviewNumber').innerText = getreview
