function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('homewarrantyreviews_test')) {
		...
		var checkStickyBar = setInterval(function() {
			if(document.querySelectorAll('.new_profile_page .sidebar_form').length > 0) {
				...
				<div class="company_info">
					...
					<div>
						<div class="horizontal_dotted_line"><span class="premium_content">Customer Reviews</span><span class="dot"></span><span class="premium_val reviewNumber">439</span></div>
		...
		// section move
		// document.querySelector('.homewarrantyreviews_test .new_profile_page .jump_link_list').before(document.querySelector('.homewarrantyreviews_test .rating_block_new_profile'));

		// document.querySelectorAll('.new_profile_page > .container-fluid:first-child')[0].classList.add('hero_section')
		// document.querySelector('.homewarrantyreviews_test .rating_block_new_profile').before(document.querySelector('.hero_section'));

		// var rows = document.querySelectorAll('.homewarrantyreviews_test .hero_section > .row');
		...
		//  </div>
		//  <div>
		// 	<div class="horizontal_dotted_line"><span class="premium_content">Customer Reviews</span><span class="dot"></span><span class="premium_val reviewNumber" id="reviewNumber">439</span></div>
		// 	<div class="horizontal_dotted_line"><span class="premium_content">Premium</span><span class="dot"></span><span class="premium_val">$5-$350</span></div>
		// 	<div class="horizontal_dotted_line"><span class="premium_content">Service Fee</span><span class="dot"></span><span class="premium_val">$0</span></div>
		// 	<div class="horizontal_dotted_line"><span class="premium_content">Limit</span><span class="dot"></span><span class="premium_val">Upto item value</span></div>
		//    <!--  <div class="horizontal_dotted_line"><span class="premium_content">Activation</span><span class="dot"></span><span class="premium_val">30 Days</span></div> -->
		...
		// document.querySelector('#reviews_section h2').textContent = "Lowe's Appliance Extended Warranty User Reviews";
		...
		// 		var Form = document.getElementById('profilepagesidebar_form').parentElement
		// 		var addBeforeThis = document.querySelector('#FAQs');
		// 		var newItem = document.createElement('div');
		// 		newItem.className = "form_wrapper";
		// 		newItem.innerHTML = '';
		// 		addBeforeThis.parentNode.insertBefore(newItem,addBeforeThis);
		// 		document.querySelector('.form_wrapper').appendChild(Form);;
