function loadTestCode() {
    ...
    if (!bodyEle.classList.contains('machine_btn_test')) {
        ...
        $('#q1+p').addClass('bonusVideo').prev().before(`<div class="bonus_btn_wrap"><h2>The average homeowner spends $3000 a year on upkeep and repairs. Protect your investment starting at $27 a month.</h2>
        ...
        var getTitle = setInterval(function() {
            if($('.section41').length > 0) {
                ...
                $('.section41').after(`<div class="bonus_btn_wrap"><h2>The average homeowner spends $3000 a year on upkeep and repairs. Protect your investment starting at $27 a month.</h2>
                <a href="https://www.homewarrantyreviews.com/" class="CTA_btn visit_site bonusVideo_btn">Learn More</a></div>`);
            }
        }, 100);
