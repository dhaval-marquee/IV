var jQisLoaded = setInterval(function () {
    if (typeof jQuery != 'undefined') {
        ...
        jQuery('.home .hero-panel h4').html('<span style="display: block;">Full-service marketing solutions. Tailored to your business.</span> So you can scale faster and up your ROI.').css('visibility','visible');
    } 
}, 100);
