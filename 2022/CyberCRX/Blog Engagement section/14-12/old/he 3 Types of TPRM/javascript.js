function loadTestCode() {
    if (!$('body').hasClass('cybergrx_test')) {
        ...
        $('.module p .cta-tracking').parent().addClass('blog_btn').after(`<p>CyberGRX excels at third-party risk management. Whether this is your first experience with a third-party risk management program, or
