function IVTestCode() {
    if (!$('body').hasClass('cybergrx_iv')) {
        ...
        $('.cybergrx_iv .mod-banner.mod-banner-l .content-banner p + p').after($('.f-landing-right .style-ul-check div:nth-child(2)'));
        $('.cybergrx_iv .mod-banner.mod-banner-l .content-banner h2 + p').html('<strong>September 20th, 2022 @ 2pm MST</strong>');
        $('.cybergrx_iv .mod-banner.mod-banner-l .content-banner h2 + p + p').html('Only 16% of organizations say they effectively manage third-party risks.');
