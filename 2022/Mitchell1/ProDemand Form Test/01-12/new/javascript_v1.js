    ...
    if(!$('body').hasClass('iv_prodemand')) {
        ...
        var hsformsInterval = setInterval(function () {
            if ($('.iv_prodemand .hbspt-form').length > 0) {
                ...
                $('.hbspt-form').after('<h1 style="font-family:Arial, Helvetica, sans-serif;text-align:center;font-size:35px;font-weight:bold;color:#33475b;margin:15px auto;">BOOK YOUR FREE DEMO TODAY!</h1><div><a href="//mitchell1.com" title="Go back to the homepage" style="background-color:#000;display:inline-block;padding:10px 10px 5px;"><span style="display:block;max-width:160px;margin:0 auto;height:33px;overflow:hidden;"><img width="240" height="70" src="//mitchell1.com/wp-content/uploads/2015/04/mitchell1_wht_mbl.png" alt="Mitchell 1"/></span><span style="color:#FFFFFF;font-family:HelveticaNeueLTStd-XBlkCn;font-size:45px;line-height:1;">ProDemand</span></a></div>');
            }
        }, 200);
