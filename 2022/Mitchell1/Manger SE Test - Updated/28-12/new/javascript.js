    ...
    if(!$('body').hasClass('iv_prodemand')) {
        ...
        var hsformsInterval = setInterval(function () {
            if ($('.iv_prodemand .hbspt-form').length > 0) {
                ...
                $('.hbspt-form').after('<p style="text-align: center;font-family: Arial, Helvetica, sans-serif;font-size: 30px;color:#33475b;">Find out if our Shop Management Software is right for you and get 3 MONTHS FREE!*</p><h1 style="font-family: Arial, Helvetica, sans-serif;text-align: center;font-size: 35px;font-weight: bold;color:#33475b;margin: 25px auto;">BOOK A FREE DEMO TODAY!</h1>');
            }
        }, 200);
        ...
        var informationContentOne = '<ul>'+
            ...
            '<li><strong>Manager SE Truck Edition:</strong> An industry-first, providing shops that service Class 4-8 trucks with integrated repair, labor estimating (with industry VMRS codes) and management tools.</li>'+
        ...
        var informationContentTwo = '<ul>'+
            '<li><strong>ProSpect:</strong> Use your mobile device to complete the check-in and vehicle ID process and begin performing inspections on the spot.</li>'+
        ...
        '<div class="cs-container">'+
            '<div class="inner-information reverse">'+
                '<div class="info-text">'+
                    ...
                    '<div class="repair_link"><a href="https://mitchell1.com/manager-se/business-management/">Learn More</a></div>'+
                '</div>'+
                '<div class="img-box">'+
        ...
        '<div class="cs-container">'+
            '<div class="inner-information reverse">'+
                ...
                '<div class="info-text">'+
                    ...
                    '<p>Service your customers’ vehicles faster and more efficiently with modern service writing tools including plate-to-VIN decoding, customizable multi-point digital inspections, vehicle history reports, integrated texting (option) to facilitate fast customer communications.</p>'+
                    '<div class="repair_link"><a href="https://mitchell1.com/manager-se/service-writer/">Learn more</a></div>'+
                '</div>'+
                '<div class="for-mobile">'+
                    '<p>Service your customers’ vehicles faster and more efficiently with modern service writing tools including plate-to-VIN decoding, customizable multi-point digital  inspections, vehicle history reports, integrated texting (option) to facilitate fast customer communications.</p>'+
                '</div>'+
        ...
        '<div class="cs-container">'+
            '<div class="inner-information reverse">'+
                '<div class="info-text">'+
                    ...
                    '<p>Quickly build accurate, profitable estimates with confidence. Manager SE is tightly integrated with ProDemand providing instant access to our industry standard labor guide, OEM parts, maintenance (with labor times), Technical Service Bulletins (TSBs) recalls plus fluid types & capacities</p>'+
                    '<div class="repair_link"><a href="https://mitchell1.com/manager-se/estimating/">Learn More</a></div>'+
                '</div>'+
                '<div class="img-box">'+
        ...
        '<div class="cs-container">'+
            '<div class="inner-information reverse">'+
                ...
                '<h3>POWERFUL <span class="text-grey">OPTIONS</span></h3>'+
                    ...
                    '<div class="repair_link"><a href="https://mitchell1.com/shop-management/">See More Options</a></div>'+
                '</div>'+
                '<div class="img-box">'+
