...
if(!bodyEle.classList.contains('iv_dello_home')) {
    ...
    var appointmentHtml = '<div><a class="hero-appointment-link" href="/lasik-center/appointment/">Schedule Your Appointment Now</a><div class="offer_end_text">*Offer ends Sept 30th</div></div>';
