...
if(!bodyEle.classList.contains('iv_dello_home')) {
    ...
    var appointmentHtml = '<div><a class="hero-appointment-link" href="https://www.dellorusso.com/lasik-center/a-b">Book Your Appointment&nbsp;Now</a><div class="offer_end_text">*Offer ends Sept 30th</div></div>';
    ...
    document.querySelector('.iv_dello_home .fusion-builder-row-2 .fusion-row').insertAdjacentHTML('beforebegin',
        ...
        '<h4><b>$0 down, 0% interest for 24 months* </b> on Lasik services and&nbsp;free yourself from glasses and contacts once and for&nbsp;all.</h4>' +
