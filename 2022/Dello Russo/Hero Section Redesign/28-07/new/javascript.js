...
if(!bodyEle.classList.contains('iv_dello_home')) {
    bodyEle.classList.add('iv_dello_home');

    var appointmentHtml = '<div><a class="hero-appointment-link" href="/lasik-center/appointment/">Schedule Your Appointment Now</a><div class="offer_end_text">*Offer ends Aug 31</div></div>';
    var rateHtml = `<div class="rated">
        <div class="rated-title fusion-no-large-visibility">
            <b>Our Patients Love Us!</b>
        </div>
    ...
    var addBeforeThis = document.querySelector('.iv_dello_home #mobile_media_new .fusion-builder-row.fusion-row');
    var newItem = document.createElement('div');
    newItem.className = "hero-block";
    newItem.innerHTML = `<div class="hero-wrap">
        <h2 class="hero-title">Create a Clearer Future</h2>
        <h4><b>Save $1500*</b> on Lasik services and free yourself from glasses and contacts once and for all.</h4>
